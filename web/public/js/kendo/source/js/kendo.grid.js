...
(function($, undefined) {
    var kendo = window.kendo,
        ...
        FUNCTION = "function",
        STRING = "string",
        DELETECONFIRM = "esta seguro de eliminar este registro?",
        formatRegExp = /\}/ig,
    ...
    var Grid = Widget.extend(/** @lends kendo.ui.Grid.prototype */ {
         ...
         */
		 ...
		 /*
		 Modificado 05/01/2012
		 kenneth jimenez pluas
		 telconet
		 */
        removeRow: function(row) {
			...
			if (((that.editable && that.editable.end()) || !that.editable) && !that.trigger(REMOVE)) {
        ...
        _tmpl: function(rowTemplate, alt) {
            ...
            if (!rowTemplate) {
                ...
                for (idx = 0; idx < length; idx++) {
					...
					if(column.field != "accionesPaquetePlanificacion" && column.field != "accionesPaqueteProgramacion"){
						rowTemplate += "<td>";
						rowTemplate += that._cellTmpl(column, state);
						rowTemplate += "</td>";
					}
					if(column.field == "accionesPaquetePlanificacion"){
						rowTemplate += '<td align="center" style="${ boton }" ><a class="k-button k-button-icontext" href="${ jsMap }" /><img class="img-grid" src="${ srcMap }" title="Ver Mapa"/></a><a class="k-button k-button-icontext" href="${ jsCroquis }" /><img class="img-grid" src="${ srcSearch }" title="ver Croquis" /></a><a class="k-button k-button-icontext" href="${ jsRechazaOrden }" /><img class="img-grid" src="${ srcRechazar }" title="Rechazar Orden"/></a><a class="k-button k-button-icontext" href="${ jsSolicitarProgramacion }" /><img class="img-grid" src="${ srcTime }" title="Factibilidad" /></a></td>';
					}
					
					if(column.field == "accionesPaqueteProgramacion"){
						rowTemplate += '<td align="center" style="${ boton }" ><a class="k-button k-icontext" href="${ jsProgramacion }" /><img class="img-grid" src="${ srcProgramar }" title="Programar" /></a><a class="k-button k-icontext" href="${ jsReplanificar}" /><img class="img-grid" src="${ srcReplanificar }" title="Replanificar" /></a><a class="k-button k-icontext" href="${ jsRechazaOrden }" /><img class="img-grid" src="${ srcRechazar }" title="Rechazar Orden" /></a></td>';
					}
                }
