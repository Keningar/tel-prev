                        ...
                        {   
                            ...
                            getClass: function(v, meta, rec) {
								...
								else
                                {
                                    ...
                                    {
                                        this.items[3].tooltip = 'Factibilidad ';
                                    }
                                }
									
								return rec.get('action4')
							},
                            tooltip: 'Factibilidad',
                            handler: function(grid, rowIndex, colIndex) {
                                var rec = store.getAt(rowIndex);
                        ...
                        ,
                        {
                            getClass: function(v, meta, rec) {
								...
								else
                                {
                                    if ("TN" === rec.get("strPrefijoEmpresa")) 
                                    {    
                                        this.items[4].tooltip = 'Factibilidad';
                                    }
                                    else
                                    {
                                        this.items[4].tooltip = 'Factibilidad Materiales';
                                    }
                                }
									
								return rec.get('action5')
							},
                            tooltip: 'Factibilidad Materiales',
                            handler: function(grid, rowIndex, colIndex) {
                                var rec = store.getAt(rowIndex);
...
//                                                                     Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');	
                        ...
                        getClass: function(v, meta, rec) {
                            ...
                            else
                            {
                                if ("TN" === rec.get("strPrefijoEmpresa"))
                                {
                                    this.items[4].tooltip = 'Factibilidad Anticipada';
                                }
                            }
