...
Ext.onReady(function() {
                                ...
                                var r = Ext.create('PlantilaHorarioModel',
                                    {
                                        ...
                                        horaFin: '',
                                        almuerzo: '',
                                        cupoWeb: intCupoWeb.getValue(),
                                        cupoMobile: intCupoMobile.getValue()
                                    });
    ...
    formPlantillaDet = Ext.create('Ext.form.Panel', {
        ...
        renderTo: 'Div_New_Plantilla_Horario',
        frame: true,
        //layout:'vbox',
        layoutConfig: {
            type: 'table',
        ...
        buttons: [
            {
                ...
                handler: function() {
                    ...
                    var strJurisdiccion = form.findField('cmbJurisdiccion');
                    ...
                    if (form.isValid())
                    {
                        var totalCupos = intCupoTotal.getValue();
                        var totalCupoRegistro = intCupoWeb.getValue() + intCupoMobile.getValue();
                        var totalCuposRegistro = 0;
                        ...
                        if (arrayGridCreaPlantillaDet.getStore().getCount() !== 0)
                        {
                                ...
                                intCounterStore < arrayGridCreaPlantillaDet.getStore().getCount(); intCounterStore++)
                            {
                                ...
                                totalLinea = arrayGridCreaPlantillaDet.getStore().getAt(intCounterStore).data.cupoWeb + arrayGridCreaPlantillaDet.getStore().getAt(intCounterStore).data.cupoMobile;
                                totalCuposRegistro += totalLinea;
                                console.log(totalCupoRegistro);
                                console.log(totalLinea);
                                if (totalCupoRegistro !== totalLinea)
                                {
                                    errorTotal = true;
                                }
                            ...
                            if (errorTotal)
                            {
                                Ext.Msg.alert("Error2 - Creación de Plantillas de Horarios", "Total de cupos web y movil deben ser igual a los declarados en la cabecera");
                                strDescripcion.focus();
                                return false;
                            }
                            if (totalCupos !== totalCuposRegistro)
                            {
                                Ext.Msg.alert("Error2 - Creación de Plantillas de Horarios", "La suma de todos los cupos debe ser " + totalCupos);
                                strDescripcion.focus();
                                return false;
                            }
                        ...
                        Ext.Ajax.request({
                            ...
                            params: {
                                ...
                                intJurisdiccion: strJurisdiccion.getValue(),
