...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    show: function(o, animateTarget){
        ...
        if (o.data) {            
            ...
            var estado = o.data.Estado;
            var title = o.data.Title;
            var arrayTitle = title.split(' - ');
            var login = arrayTitle[0];
            var sector = arrayTitle[1];            
            ...
            formPanel = Ext.create('Ext.form.Panel', {
                    ...
                    items: [{
                        ...
                        items: [
                            ...
                            {
                                xtype: 'textfield',
                                fieldLabel: 'Rango hora de Asignacion:',
                                id: 'calendario_horaAsignacion',
                                name: 'calendario_horaAsignacion',
                                value: o.data.StartDate.toLocaleTimeString() + ' - ' + o.data.EndDate.toLocaleTimeString(),
                                readOnly: true
                            }
                        ]
                    }]
