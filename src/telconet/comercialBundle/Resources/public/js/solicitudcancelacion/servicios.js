	...
	Ext.form.VTypes["porcentajeVtypeMask"]=/[\d\.]/;
                ...
                if(sm.getSelection().length > 0)
                {
                  ...
                  if(motivo_id)
                  {
                        ...
                        if(Ext.getCmp('fechaCancelacion').getValue() ){
                            ...
                            Ext.Msg.alert('Alerta ','Por favor ingresar fecha de cancelacion');
            ...
            function ejecutaEnvioSolicitud(param){
                        ...
                        Ext.Msg.confirm('Alerta','Se solicitara cancelacion para los registros seleccionados. Desea continuar?', function(btn){
                            if(btn=='yes'){
                                //alert(motivo_id);
                                Ext.Ajax.request({
