	...
	Ext.form.VTypes["porcentajeVtypeMask"]=/[\d\.]/;
            function solicitarCancelacion(){
                 //console.log(TFPrecio.getValue());

                //console.log(TipoValor.getValue().tipoDoc);
                var param = '';
                        ...
                        Ext.Msg.confirm('Alerta','Se solicitara cambio de equipo para los registros seleccionados. Desea continuar?', function(btn){
                            if(btn=='yes'){
                                ...
                                Ext.Ajax.request({
                                    ...
                                    method: 'post',
                                    params: { param : param, motivoId:motivo_id, rs: relacion_sistema_id, ts:tipo_solicitud_id, fecha:DTFechaCancelacion.getValue(), obs:TFObservacion.getValue(), td:TipoValor.getValue().tipoDoc, valor:TFPrecio.getValue()},
                    ...
                    listeners:{
                       select: function( selectionModel, record, index, eOpts ){
                           ...
                           if(record.data.yaFueSolicitada == 'S'){
                                sm.deselect(index);
                                Ext.Msg.alert('Alerta','Ya fue solicitado cambio de equipo para el servicio: '+record.data.descripcionProducto);
                            }
