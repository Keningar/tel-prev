...
function eliminarContacto(id, intIdPersonaEmpresaRol) {
    Ext.Msg.confirm('Alerta', 'Se eliminara el registro. Desea continuar?', function(btn) {
        if (btn === 'yes') {
            Ext.MessageBox.show({
                msg: 'Inactivando contacto...',
                title: 'Inactivando',
                progressText: 'Inactivando.',
                progress: true,
                closable: false,
                width: 300,
                wait: true,
...
Ext.onReady(function() {
    ...
    var listView = Ext.create('Ext.grid.Panel', {
        ...
        dockedItems: [{
                ...
                align: '->',
                items: [{xtype: 'tbfill'}]}],
        renderTo: Ext.get('lista_contactos'),
    ...
    function renderAcciones(value, p, record) {
        ...
        if (record.data.estado != 'Inactivo') {
            ...
            iconos = iconos + '<b><a href="#" onClick="eliminarContacto(' + record.data.idPersona + ', ' + record.data.intIdPersonaEmpresaRol +
                ')" title="Eliminar" ' +
