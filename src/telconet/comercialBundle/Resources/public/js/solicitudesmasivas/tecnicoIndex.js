                        ...
                        params:
                            {
                                ...
                                boolMasivas: true,          
                                boolReqArchivo: true,
                                boolReqAprobPrecio: false,
                                boolReqAprobRadio: ((tipoAprobacion === 'ipccl2') ? false : true),
                                boolReqAprobIpccl2: ((tipoAprobacion === 'ipccl2') ? true : false),
                                strEstadoDetalles: 'Aprobada',
                                strEstadoAprobPrecio: 'Aprobada,N/A',
                                strEstadoAprobRadio: ((tipoAprobacion === 'ipccl2') ? 'Aprobada,N/A' : 'Pendiente'),
                                strEstadoAprobIpccl2: ((tipoAprobacion === 'ipccl2') ? 'Pendiente' : '')
                            }
                    });
                }
            },
        ...
        columns: [
             {
              ...
              },
              {
                  ...
                  items: [
                    ...
                    {
                        getClass: function(v, meta, rec) {
                            var permiso_aprobarRadio = $("#ROLE_351-163");
                            var permiso_rechazarRadio = $("#ROLE_351-94");
                            var boolPermisoRadio = (typeof permiso_aprobarRadio === 'undefined' && typeof permiso_rechazarRadio === 'undefined') ? false : (permiso_aprobarRadio.val() == 1 || permiso_rechazarRadio.val() == 1 ? true : false) && tipoAprobacion == 'radio';
                            
                            var permiso_aprobarIpccl2 = $("#ROLE_352-163");
                            var permiso_rechazarIpccl2 = $("#ROLE_352-94");
                            var boolPermisoIpccl2 = (typeof permiso_aprobarIpccl2 === 'undefined' && typeof permiso_rechazarIpccl2 === 'undefined') ? false : (permiso_aprobarIpccl2.val() == 1 || permiso_rechazarIpccl2.val() == 1 ? true : false) && tipoAprobacion == 'ipccl2';
