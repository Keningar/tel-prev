   ...
   var arraySolicitudesSeleccionadas = new Array();
    ...
    Ext.define('modelServiciosSeleccionados', {
        ...
        fields: [
            ...
            {name: 'strEstadoCambioPrecio', type: 'string'}
        ]
    });
    ...
    chkBoxModelSolicitudesSeleccionadas = new Ext.selection.CheckboxModel({
        ...
        renderer : function(val, meta, record, rowIndex, colIndex, store,view){
            if(record.get('strEstado')==='Rechazada' || record.get('strEstado')==='Aprobada'
                || record.get('strEstado')==='EnProceso' || record.get('strEstado')==='Finalizada' || record.get('strEstado')==='Fallo' || strArchivo == ''){
                return '';
            }else{
        ...
        columns: [
            ...
            },    
            {
                ...
                items: [
                    ...
                    {
                        getClass: function(v, meta, rec) {
                            var permiso = $("#ROLE_347-163");
                            var boolPermiso = (typeof permiso === 'undefined') ? false : (permiso.val() == 1 ? true : false);
                            if (boolPermiso && rec.get('strEstado') === 'Pendiente' && strArchivo != '') {
