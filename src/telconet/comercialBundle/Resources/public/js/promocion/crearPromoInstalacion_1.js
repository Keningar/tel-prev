$(document).ready(function () {  
    ...
    Array.prototype.filter.call(forms, function (form) {
        form.addEventListener('submit', function (event) {
            ...
            } else
            {
                ...
                {
                    $('#modalMensajes .modal-body').html("Debe ingresar al menos un Forma de Pago por Débito Bancario.");
                    $('#modalMensajes').modal({show: true});
    ...
    // Jurisdicción, Cantón, Parroquia, Sector, Olt
       $.ajax({
    ...
    //Obtiene los cantones para la sectorización
    ...
    //Obtiene las parroquias para la sectorización.
    ...
    //Obtiene los Sectores/Olt's para la sectorización.
   ...
   $.ajax({
        ...
        error: function () {
            $('#modalMensajes .modal-body').html("No se pueden cargar los Períodos.");
            $('#modalMensajes').modal({show: true});
        }
    });
     ...
     $.ajax({
        ...
        success: function (data) {
            $.each(data.estados_servicios, function (id, registro) {
                $("#estado_servicio").append('<option value=' + registro.id + ' selected="selected">' + registro.nombre + '</option>');
            });
        },
        error: function () {            
    ...
    */
    ...
    /**
    * Funciones para cargar Emisores
    * @author Anabelle Peñaherrera <apenaherrera@telconet.ec>
