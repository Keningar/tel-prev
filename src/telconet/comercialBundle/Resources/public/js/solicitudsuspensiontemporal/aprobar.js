            ...
            TFLogin = new Ext.form.TextField({
                ...
                var listView = Ext.create('Ext.grid.Panel', {
                    ...
                    bbar: Ext.create('Ext.PagingToolbar', {
                        store: store,
                        displayInfo: true,
                        displayMsg: 'Mostrando solicitudes de suspension {0} - {1} of {2}',
...
function rechazarAlgunos(){
    ...
    if(sm.getSelection().length > 0)
    {
      ...
      if(estado == 0)
      {
       ...
       {
        alert('Debe seleccionar un motivo para poder anular la(s) solicitud(es) de suspension de servicios.');                
       } 
      }
      else
      {
