/**
 *
 * Rollback de actualización de plantillas TM Comercial
 *
...
DECLARE
    ...
    plantilla_editada_contrato_sd   CLOB := '<!DOCTYPE html>';
...
BEGIN
    ...
    DBMS_LOB.APPEND(plantilla_editada_contrato, '
      <div id="contenedor" class="col-width-100" style="font-size:14px;">
         ...
         <!-- ========================================================= -->
         <div style="clear: both;"></div>
         <div class="labelBlock">CONTRATO DE ADHESI&Oacute;N DE PRESTACI&Oacute;N DE SERVICIOS DE ACCESO A INTERNET/PORTADO R</div>
    ...
    ------ ADENDUM ------
    DBMS_LOB.APPEND(plantilla_editada_adendum, '<!DOCTYPE html> 
<html>
<head>
...
<body>
  ...
  <div id="contenedor" class="col-width-100" style="font-size:14px;">
    ...
    ----------------------------
   ------ CONTRATO SD ------
    DBMS_LOB.APPEND(plantilla_editada_contrato_sd, '
...
<p style="position:absolute;top:3020px;left:134px;white-space:nowrap" class="ft05">(fecha de emisi&oacute;n):<span class="box" style="width:120px; text-align: center;">$fechaActual</span></p>
...
<img style="position:absolute;top:3500px;left:200px" width="400" height="150" src="http://images.telconet.net/others/telcos/footer_security_data.png" alt="background image">
    ...
    UPDATE DB_FIRMAELECT.ADM_EMPRESA_PLANTILLA t SET t.HTML= plantilla_editada_contrato_sd where t.COD_PLANTILLA = 'contratoSecurityData' AND ESTADO = 'Activo';
    DBMS_OUTPUT.PUT_LINE('OK contratoSecurityData');
    ----------------------------
