--Actualizando Plantillas ENC-VIS-TN
...
<head>
  ...
  <style type="text/css">
      ...
      td.style2 { vertical-align:bottom; text-align:left; padding-right:0px; border-bottom:1px solid #000000 !important; padding-left: 5px; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#000000; font-family:Calibri; font-size:11pt; background-color:white }
      ...
      td.style14 { vertical-align:middle; text-align:left; padding-left:0px;padding-top: 5px;padding-bottom: 5px; padding-left: 5px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#000000; font-family:Calibri; font-size:13pt; background-color:#FFFFFF }

      th.style14 { padding:3; vertical-align:middle; text-align:left;padding-top: 5px;padding-bottom: 5px; padding-left:0px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#000000; font-family:Calibri; font-size:13pt; background-color:#FFFFFF }
      ...
      td.style26 { vertical-align:middle; text-align:center; border-bottom:none #000000; border-top:1px solid #000000; border-left:none #000000; border-right:1px solid #000000 !important; font-weight:bold; color:#1F497D; font-family:Calibri; font-size:14pt; background-color:white }
      th.style26 { vertical-align:middle; text-align:center; border-bottom:none #000000; border-top:none #000000; border-left:none #000000; border-right:1px solid #000000 !important; font-weight:bold; color:#1F497D; font-family:Calibri; font-size:14pt; background-color:white }
        ...
        <tbody>
          <tr class="row0">
            <td class="column0 style11 null style11">
                <div><img width= 150 height= 65 src={{imagenCabecera}} border="0" colspan="2" /></div></td>
                <td class="column1 style24 s style26" colspan="8">ENCUESTA DE CALIDAD DE SOPORTE CORPORATIVO</td>
                <td class="column7 style22 s style22" colspan="3">C&Oacute;DIGO: FOR GC 14<br />
                    Ver: 02 (12 07 2021)</td>
                </tr>
                <tr class="row2">
                    <td class="column0 style15 s style17" colspan="100%">DATOS GENERALES</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Razon Social:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ datoGeneral.strRazonSocial }}</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Nombre del Contacto en Sitio:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ strNombreContactoSitio }}</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Número del Contacto en Sitio:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ strNumeroContactoSitio }}</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Cuadrilla Instalación:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ strNombreCuadrilla }}</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Jefe de Cuadrilla:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ strJefeCuadrilla }}</td>
                </tr>
                 <tr class="row3">
                    <td class="column0 style2 s" colspan="3">Integrantes Cuadrilla:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ strIntegrantesCuadrilla }}</td>
                </tr>
                <tr class="row9">
                    <td class="column0 style1 s" colspan="3">Fecha y hora Encuesta:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ datoGeneral.fechaEncuesta }}</td>
                </tr>

                <tr class="row10">
                    <td class="column0 style15 s style17" colspan="100%">DETALLES DEL SERVICIO</td>
                </tr>
                <tr class="row11">
                    <td class="column0 style2 s"colspan="3">Login:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ detalleCliente .strLogin }}</td>
                </tr>
                <tr class="row12">
                    <td class="column0 style2 s"colspan="3">Provincia:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ detalleCliente .strProvincia }}</td>
                </tr>
                <tr class="row13">
                    <td class="column0 style2 s" colspan="3">Ciudad:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ detalleCliente .strCanton }}</td>
                </tr>
                <tr class="row14">
                    <td class="column0 style5 s" colspan="3">Tipo Enlace Última Milla:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ detalleCliente .strUltimaMill }}</td>
                </tr>
                 <tr class="row14">
                    <td class="column0 style5 s" colspan="3">Fecha subcripción del contrato:</td>
                    <td align="center" class="column1 style11 null style11" colspan="7">{{ strFechaContrato }}</td>
                </tr>
                <tr class="row16">
                    <td class="column0 style15 s style17" colspan="100%">PREGUNTAS</td>
                </tr>
                ...
                {%endfor%}
                <tr class="row32">
                    <td class="column0 style4 s"  colspan="2">FIRMA DEL CONTACTO EN SITIO</td>
                    <td align="center" class="column1 style46 null style47" colspan="8"><img src="{{firmaCliente}}" alt="firma" width="150" height="200"/></td>
                </tr>
                <tr class="row33">
                    <td class="column0 style40 s style42" colspan="10">“Agradecemos sinceramente su esfuerzo y colaboraci&oacute;n” </td>
                </tr>
            </tbody>
    </table>
</body>
