    /**
     * Se realiza la actualización de parámetros y cargos.
     *
     * @author Kevin Baque Puya <kbaque@telconet.ec>
     * @version 1.0 03-12-2021
     */
    --Actualizamos los rangos de asignación de solicitudes
    ...
    --Actualizamos el cargo del usuario mescobar
    ...
    --Actualizamos el cargo del usuario jyerovi
    UPDATE DB_COMERCIAL.INFO_PERSONA_EMPRESA_ROL_CARAC
    SET
        ESTADO = 'Eliminado',
        USR_ULT_MOD = 'kbaque'
    ...
    SET
        PORCENTAJE_DESCUENTO = '15.09'
    WHERE
        EMPRESA_ROL_ID IN ( 3470, 90 )
        AND PORCENTAJE_DESCUENTO = '10';
