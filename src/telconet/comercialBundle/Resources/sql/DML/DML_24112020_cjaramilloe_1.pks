/**
 *
 * Actualización de plantilla adendum TM Comercial
 *
...
<head>
  ...
  <div id="contenedor" class="col-width-100" style="font-size:14px;">
    ...
    <tr style="$!verLeyenda">
        <td class="col-width-75" style="font-size:14px;">FE DE ERRATAS: este adendum es emitido como corrección al adenum del contrato $!numeroContrato</td>
    </tr>
    ...
    <div class="labelBlock">DATOS DE CONTACTO</div>
        <div id="contenedor" class="col-width-100">
          <div id="row">
            ...
            <div id="col" class="col-width-2-5"></div>
            <div id="col" class="col-width-15">Tel&amp;éfono contacto:</div>
            <div id="col" class="col-width-15 labelGris">$!celularContacto<span class="textPadding"></span></div>
            <div id="col" class="col-width-2-5"></div>
            <div id="col" class="col-width-15">Tel&amp;éfono fijo contacto:</div>
        ...
        <div id="contenedor" class="col-width-100">
            <div id="row">
                ...
                <div id="col" class="col-width-90 labelGris">
                    <span class="textPadding" style="font-size:8px">$!obsPromocion</span>
                </div>
            </div>
        </div>
