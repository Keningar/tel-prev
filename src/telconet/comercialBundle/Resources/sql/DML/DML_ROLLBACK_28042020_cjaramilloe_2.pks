...
<!-- ============================== -->
    ...
    plantilla_editada_contrato_sd := REPLACE(registro_contrato_sd.HTML, '.ft08{font-size:13px;line-height:21px;font-family:"ARIAL";color:#000000;}
    .box{height: 16px; width: auto; border: 1px solid black; display:inline-block; border-radius: 2px; -moz-border-radius: 2px; -webkit-border-radius: 2px ; vertical-align: center; text-align: left;}' ,'.ft08{font-size:13px;line-height:21px;font-family:"ARIAL";color:#000000;}');
        
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd, '<p style="position:absolute;top:3318px;left:134px;white-space:nowrap" class="ft04">' ,'<p style="position:absolute;top:3304px;left:134px;white-space:nowrap" class="ft04">');
    
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd, '<p style="position:absolute;top:149px;left:58px;width:793px;height:18px;border: solid 1px #000000;" class="ft06"><i><b>Persona Natural:</b></i><span class="box">$isPersonaNatural</span></p>', '<p style="position:absolute;top:149px;left:58px;width:793px;height:18px;border: solid 1px #000000;" class="ft06"><i><b>Persona Natural:<input type="checkbox" name="persona" value="$isPersonaNatural" checked=""/></b></i></p>');
      
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd, '<p style="position:absolute;top:169px;left:58px;width:793px;height:24px;border: solid 1px #000000;" class="ft00">Nombres:<span class="box" style="width:340px;">$nombresApellidos</span>&nbsp;&nbsp;CI:<span class="box" style="width:150px;">$identificacion</span>&nbsp;&nbsp;RUC:<span class="box" style="width:150px;">$ruc</span></p>', '<p style="position:absolute;top:169px;left:58px;width:793px;height:24px;border: solid 1px #000000;" class="ft00">Nombres:<input type="text" name="nombre" id="nombre" size="34" value="$nombresApellidos"/>&nbsp;&nbsp;CI:<input type="text" name="cedula" id="cedula" size="22" value="$identificacion"/>&nbsp;&nbsp;RUC:<input type="text" name="ruc" id="ruc" size="17" value="$ruc"/></p>');
      
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd, '<p style="position:absolute;top:3020px;left:134px;white-space:nowrap" class="ft05">(fecha de emisi&oacute;n):<span class="box" style="width:120px; text-align: center;">$fechaActual</span></p>', '<p style="position:absolute;top:3020px;left:134px;white-space:nowrap" class="ft05">(fecha de emisi&oacute;n):<input type="text" name="fecha" id="fecha" value="$fechaActual"/></p>');
  
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd,'<p style="position:absolute;top:3303px;left:134px;white-space:nowrap" class="ft04"><span><b>SECURITY DATA SEGURIDAD EN</b></span><input id="inputfirma1" name="FIRMA_CONT_SD_EMPRESA" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></p>', '<p style="position:absolute;top:3292px;left:134px;white-space:nowrap" class="ft04"><b>SECURITY DATA SEGURIDAD EN</b></p>');
  
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd,'<p style="position:absolute;top:3316px;left:134px;white-space:nowrap" class="ft04"><b>DATOS Y FIRMA DIGITAL S. A.</b></p>', '<p style="position:absolute;top:3304px;left:134px;white-space:nowrap" class="ft04"><b>DATOS Y FIRMA DIGITAL S. A.</b></p>');
     
    plantilla_editada_contrato_sd := REPLACE(plantilla_editada_contrato_sd,'<p style="position:absolute;top:3303px;left:512px;white-space:nowrap" class="ft04"><span><b>EL SUSCRIPTOR</b></span><input id="inputfirma2" name="FIRMA_CONT_SD_CLIENTE" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></p>', '<p style="position:absolute;top:3303px;left:512px;white-space:nowrap" class="ft04"><b>EL SUSCRIPTOR</b></p>');
...
-->');
    ...
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:235px;left:559px;white-space:nowrap" class="ft01">Fecha:<span class="box" style="width:211px">$fechaActual</span></p>', '<p style="position:absolute;top:235px;left:559px;white-space:nowrap" class="ft01">Fecha:<input type="text" id="fecha" name="fecha" size="32" required value="$fechaActual"></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:274px;left:94px;white-space:nowrap" class="ft01">Nombres y Apellidos*:<span class="box" style="width:590px">$nombresApellidos</span></p>', '<p style="position:absolute;top:274px;left:94px;white-space:nowrap" class="ft01">Nombres y Apellidos*:<input type="text" id="nombres" name="nombres" size="86" value="$nombresApellidos" required></p>');
 
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:299px;left:94px;white-space:nowrap" class="ft01">No. C&eacute;dula / No. Pasaporte*:<span class="box" style="width:250px">$identificacion</span></p>', '<p style="position:absolute;top:299px;left:94px;white-space:nowrap" class="ft01">No. C&eacute;dula / No. Pasaporte*:<input type="text" id="cedula" name="cedula" size="38" value="$identificacion" required></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:299px;left:559px;white-space:nowrap" class="ft01">Nacionalidad*:<span class="box" style="width:169px">$nacionalidad</span></p>', '<p style="position:absolute;top:299px;left:559px;white-space:nowrap" class="ft01">Nacionalidad*:<input type="text" id="nacionalidad" name="nacionalidad" size="25" value="$nacionalidad" required></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:324px;left:94px;white-space:nowrap" class="ft01">Email*:<span class="box" style="width:377px">$emailCliente</span></p>', '<p style="position:absolute;top:324px;left:94px;white-space:nowrap" class="ft01">Email*:<input type="text" id="email" name="email" size="97" value="$emailCliente" required></p>');
     
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:414px;left:94px;white-space:nowrap" class="ft01">Direcci&oacute;n*:<span class="box" style="width:650px">$direccion</span></p>', '<p style="position:absolute;top:414px;left:94px;white-space:nowrap" class="ft01">Direcci&oacute;n*:<input type="text" id="direccion" name="direccion" size="93" value="$direccion" required></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:438px;left:94px;white-space:nowrap" class="ft01">Provincia*:<span class="box" style="width:200px">$provincia</span></p>', '<p style="position:absolute;top:438px;left:94px;white-space:nowrap" class="ft01">Provincia*:<input type="text" id="provincia" name="provincia" size="38" value="$provincia" required></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:438px;left:459px;white-space:nowrap" class="ft01">Ciudad*:<span class="box" style="width:200px">$ciudad</span></p>', '<p style="position:absolute;top:438px;left:459px;white-space:nowrap" class="ft01">Ciudad*:<input type="text" id="ciudad" name="ciudad" size="43" value="$ciudad" required></p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:463px;left:94px;white-space:nowrap" class="ft01">Tel&eacute;fono*:&nbsp;<span class="box" style="width:203px">$telefono</span></p>', '<p style="position:absolute;top:463px;left:94px;white-space:nowrap" class="ft01">Tel&eacute;fono*:<input type="text" id="telefono" name="telefono" size="39" value="$telefono" required></p>');
    
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:463px;left:459px;white-space:nowrap" class="ft01">Celular:&nbsp;<span class="box" style="width:202px">$celular</span></p>', '<p style="position:absolute;top:463px;left:459px;white-space:nowrap" class="ft01">Celular:<input type="text" id="celular" name="celular" size="44" value="$celular"></p>');
   
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:542px;left:180px;white-space:nowrap" class="ft01"><span class="box">X</span>&nbsp;&nbsp;a. 3 d&iacute;as</p>', '<p style="position:absolute;top:542px;left:180px;white-space:nowrap" class="ft01"><input type="radio" name="mes"  checked="$validezCertificadoCheck" />&nbsp;&nbsp;a. 3 d&iacute;as</p>');
  
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd, '<p style="position:absolute;top:640px;left:180px;white-space:nowrap" class="ft01"><span class="box">X</span>&nbsp;&nbsp;a. Firma de contrato con MEGADATOS</p>', '<p style="position:absolute;top:640px;left:180px;white-space:nowrap" class="ft01"><input type="checkbox" name="uso" value="$usoCertificadoCheck"  style="color: black;background-color: black" checked="checked" />&nbsp;&nbsp;a. Firma de contrato con MEGADATOS</p>');
   
    plantilla_editada_form_sd := REPLACE(plantilla_editada_form_sd,'<p style="position:absolute;top:764px;left:94px;white-space:nowrap" class="ft00"><span><b>FIRMA DEL SUSCRIPTOR</b></span><input id="inputfirma1" name="FIRMA_FORM_SD_CLIENTE" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></p>', '<p style="position:absolute;top:764px;left:94px;white-space:nowrap" class="ft00"><b>FIRMA DEL SUSCRIPTOR</b></p>');
    ...
    plantilla_editada_pagare := REPLACE(registro_pagare.HTML,'<div id="col" class="col-width-25"><span>Firma:</span><input id="inputfirma1" name="FIRMA_CONT_MD_PAGARE" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></div>', '<div id="col" class="col-width-25">Firma:</div>');
    ...
    plantilla_editada_debito := REPLACE(registro_debito.HTML,'<div id="colCell" class="col-width-20"><span>Firma del Cliente</span><input id="inputfirma1" name="FIRMA_CONT_MD_AUT_DEBITO" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></div>', '<div id="colCell" class="col-width-20">Firma del Cliente</div>');
...
');
    ...
    DBMS_LOB.APPEND(plantilla_editada_adendum,'                <tr>
