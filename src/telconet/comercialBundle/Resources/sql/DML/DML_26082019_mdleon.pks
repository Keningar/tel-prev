...
/*
* Se realiza la creación del producto INTERNET DC SDWAN tomando como base el producto INTERNET DC.
...
INSERT INTO DB_COMERCIAL.ADMI_PRODUCTO 
    ...
    WHERE AP.DESCRIPCION_PRODUCTO='INTERNET DC' 
        and AP.ESTADO='Activo' 
        and AP.NOMBRE_TECNICO='INTERNETDC' 
...
INSERT INTO DB_COMERCIAL.ADMI_PRODUCTO_CARACTERISTICA
    SELECT DB_COMERCIAL.SEQ_ADMI_PRODUCTO_CARAC.NEXTVAL,
        (SELECT ID_PRODUCTO FROM DB_COMERCIAL.ADMI_PRODUCTO WHERE DESCRIPCION_PRODUCTO='INTERNET DC SDWAN'),
...
INSERT INTO DB_COMERCIAL.ADMI_COMISION_DET
    SELECT DB_COMERCIAL.SEQ_ADMI_COMISION_DET.NEXTVAL,
        ...
        AP.DESCRIPCION_PRODUCTO='INTERNET DC SDWAN' and AP.ESTADO='Activo' and AP.NOMBRE_TECNICO='INTERNET DC SDWAN' and AP.EMPRESA_COD=10),
    ...
    WHERE ACD.COMISION_ID = (SELECT ID_COMISION 
                              ...
                              WHERE PRODUCTO_ID=(SELECT ID_PRODUCTO 
                                                 ...
                                                 WHERE AP.DESCRIPCION_PRODUCTO='INTERNET DC' 
                                                      and AP.ESTADO='Activo' 
                                                      and AP.NOMBRE_TECNICO='INTERNETDC' 
                                                      and AP.EMPRESA_COD=10)AND ESTADO='Activo');
...
INSERT INTO DB_GENERAL.ADMI_PARAMETRO_DET
    ...
    WHERE PARAMETRO_ID=(SELECT DISTINCT ID_PARAMETRO 
        ...
        AND (VALOR1='INTERNET DC' OR VALOR2='INTERNET DC');
