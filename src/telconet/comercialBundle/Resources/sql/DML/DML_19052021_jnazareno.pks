...
BEGIN
     ...
     <body>
        ...
        <div id="contenedor" class="col-width-100" style="font-size:14px;">
         <table class="col-width-100">         
           <tr>     
             <td class="col-width-75" style="font-size:12px;"><b>CONTRATO DE ADHESI&Oacute;N DE PRESTACI&Oacute;N DE SERVICIOS DE ACCESO A INTERNET/PORTADOR</b></td> 
    ...
    DBMS_LOB.APPEND(plantilla_editada_contrato, '<div id="col" class="col-width-5"></div>
...
<p style="position:absolute;top:1175px;left:54px;width:793px;height:275px;text-align: justify" class="ft05"><b>CL&aacute;USULA S&Eacute;PTIMA: OBLIGACIONES DE SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A..-</b><br />
