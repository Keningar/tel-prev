...
<head>
  ...
  <style type="text/css">
      ...
      td.style14 { vertical-align:middle; text-align:left; padding-left:0px; padding-left: 5px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#000000; font-family:Calibri; font-size:11pt; background-color:#FFFFFF }

      th.style14 { vertical-align:middle; text-align:left; padding-left:0px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; font-weight:bold; color:#000000; font-family:Calibri; font-size:11pt; background-color:#FFFFFF }
        ...
        <tbody>
          <tr class="row0">
            <td class="column0 style11 null style11">
                <div><img width= 70 height= 35 src={{imagenCabecera}} border="0" /></div></td>
                <td class="column1 style24 s style26" colspan="6">ENCUESTA DE CALIDAD SOPORTE CORPORATIVO</td>
                <td class="column7 style22 s style22">C&Oacute;DIGO: FOR GC 14<br />
                    VER 2/03/2017</td>
                </tr>
                <tr class="row2">
                ...
                <tr class="row3">
                    <td class="column0 style2 s">Nombre del Cliente:</td>
                    <td align="center" class="column1 style37 null style39" colspan="7">{{ datoGeneral.strRazonSocial }}</td>
                </tr>
                <tr class="row9">
                    <td class="column0 style1 s">Fecha y hora Encuesta:</td>
                ...
                {% for pregunta in cuerpo %}
                      <tr class="row17">
                          ...
                          <td class="column3 style6 s">{{ pregunta.respuesta }}</td>
                ...
                <tr class="row32">
                    <td class="column0 style4 s">FIRMA DEL CONTACTO EN SITIO</td>
                    <td align="center" class="column1 style46 null style47" colspan="7"><img src="{{firmaCliente}}" alt="firma" width="75%"/></td>
                </tr>
                <tr class="row33">
                    <td class="column0 style40 s style42" colspan="8">“Agradecemos sinceramente su esfuerzo y colaboraci&oacute;n” </td>
                </tr>
            </tbody>
        </table>
    </body>
