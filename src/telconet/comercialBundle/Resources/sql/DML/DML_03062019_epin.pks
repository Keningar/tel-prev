 ...
 * @version 1.0
 * @since 20-05-2019
 * Se crean las sentencias DML para modificar las plantillas de contrato digital
 */
...
DBMS_LOB.APPEND(bada, '<html>
    ...
    DBMS_LOB.APPEND(bada, '
        ...
        <!-- ======================================== -->
        <br/>');
    DBMS_LOB.APPEND(bada, '        <div style="clear: both;"></div>
...
dbms_output.put_line('Contrato MegaDatos '||dbms_lob.getlength(bada));
...
bada :='<!DOCTYPE html>';
DBMS_LOB.APPEND(bada, '<html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
<head>
...
<div id="page1-div" style="position:relative;width:893px;height:3786px;background:white">
...
<p style="position:absolute;top:54px;left:217px;white-space:nowrap" class="ft04"><b>CONTRATO DE CERTIFICADO DE FIRMA ELECTR&' || 'Oacute;NICA. </b></p>
<p style="position:absolute;top:90px;left:54px;width:793px;height:100px;text-align: justify" class="ft04"><b>COMPARECIENTES.-</b>
Security Data Seguridad en Datos y Firma Digital S. A. como Entidad de Certificaci&' || 'oacute;n de Informaci&' || 'oacute;n, representado por Roosevelt Ar&' || 'eacute;valo por una parte; y, por otra El/la se&' || 'ntilde;or/a:</p>

<p style="position:absolute;top:149px;left:58px;width:793px;height:18px;border: solid 1px #000000;" class="ft06"><i><b>Persona Natural:<input type="checkbox" name="persona" value="$isPersonaNatural" checked=""/></b></i></p>
<p style="position:absolute;top:169px;left:58px;width:793px;height:24px;border: solid 1px #000000;" class="ft00">Nombres:<input type="text" name="nombre" id="nombre" size="34" value="$nombresApellidos"/>&' || 'nbsp;&' || 'nbsp;CI:<input type="text" name="cedula" id="cedula" size="22" value="$identificacion"/>&' || 'nbsp;&' || 'nbsp;RUC:<input type="text" name="ruc" id="ruc" size="17" value="$ruc"/></p>

<p style="position:absolute;top:213px;left:54px;width:793px;height:100px;text-align: justify" class="ft05">Verificado que sus datos y descripci&' || 'oacute;n corresponde con dicho nombre, as&' || 'iacute; como, en suficiente apariencia con su imagen, por sus propios derechos, o en representaci&' || 'oacute;n de una entidad a quien en adelante se denominar&' || 'aacute; El Suscriptor, conforme los documentos habilitantes legalmente conferidos que se adjuntan convienen en celebrar el presente Contrato, al tenor de las siguientes cl&' || 'aacute;usulas:</p>

    <p style="position:absolute;top:305px;left:54px;width:793px;height:275px;text-align: justify" class="ft05"><b>CL&' || 'aacute;USULA PRIMERA: ANTECEDENTES.- </b><br />1. Mediante Ley No. 67, publicada en el Suplemento del Registro Oficial No. 577 de 17 de abril del 2002 se expidi&' || 'oacute; la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos.<br />
2. Con Decreto No. 3496 publicado en el Registro Oficial 735 de 31 de diciembre de 2002, se expidi&' || 'oacute; el Reglamento General a la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos, el mismo que fue reformado mediante Decreto Ejecutivo 1356 de 29 de septiembre de 2008, constante en el Registro Oficial No. 440 de 6 de octubre de 2008.<br />
3. El art&' || 'iacute;culo 37 de la Ley de Comercio Electr&' || 'oacute;nico dispone, que el Consejo Nacional de Telecomunicaciones (CONATEL) es el organismo de autorizaci&' || 'oacute;n, regulaci&' || 'oacute;n y registro de las Entidades de Certificaci&' || 'oacute;n Acreditadas<br />
4.El segundo art&' || 'iacute;culo innumerado agregado por el art&' || 'iacute;culo 4 del Decreto Ejecutivo No.1356 a continuaci&' || 'oacute;n del art&' || 'iacute;culo 17 del Reglamento General a la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos, dispone que la Acreditaci&' || 'oacute;n como Entidad de Certificaci&' || 'oacute;n de Informaci&' || 'oacute;n y Servicios Relacionados, consistir&' || 'aacute; en un acto administrativo emitido por el CONATEL, a trav&' || 'eacute;s de una resoluci&' || 'oacute;n que ser&' || 'aacute; inscrita en el Registro P&' || 'uacute;blico Nacional de Entidades de Certificaci&' || 'oacute;n de Informaci&' || 'oacute;n y Servicios Relacionados Acreditadas y Terceros Vinculados.<br />
5 .El CONATEL mediante Resoluci&' || 'oacute;n No. 481-20-CONATEL-2008 de 8 de octubre de 2008, aprob&' || 'oacute; la petici&' || 'oacute;n de Acreditaci&' || 'oacute;n de Security Data Seguridad en Datos y Firma Digital S. A. como Entidad de Certificaci&' || 'oacute;n de Informaci&' || 'oacute;n y Servicios Relacionados, para lo cual la Secretar&' || 'iacute;a Nacional de Telecomunicaciones (SENATEL) suscribi&' || 'oacute; el respectivo acto administrativo.<br />
</p>
<p style="position:absolute;top:586px;left:54px;width:793px;height:275px;text-align: justify" class="ft04"><b>CL&' || 'aacute;USULA SEGUNDA: OBJETO.- </b>El presente contrato tiene por objeto la prestaci&' || 'oacute;n de los servicios de certificaci&' || 'oacute;n de Informaci&' || 'oacute;n y servicios relacionados, contempla la emisi&' || 'oacute;n, suspensi&' || 'oacute;n, revocaci&' || 'oacute;n y renovaci&' || 'oacute;n de Certificados de Firma Electr&' || 'oacute;nica. As&' || 'iacute; mismo tiene por objeto garantizar la prestaci&' || 'oacute;n permanente, confidencial, oportuna y segura del servicio de certificaci&' || 'oacute;n de informaci&' || 'oacute;n.<br /></p>

<p style="position:absolute;top:688px;left:54px;width:793px;height:275px;text-align: justify" class="ft04"><b>CL&' || 'aacute;USULA TERCERA: NIVELES DE FIRMA.- </b>El nivel del certificado que se emite es el de certificado de firma electr&' || 'oacute;nica que servir&' || 'aacute; para todo prop&' || 'oacute;sito dentro de sus l&' || 'iacute;mites de uso, seg&' || 'uacute;n se describe en la Declaraci&' || 'oacute;n de Practicas de Certificaci&' || 'oacute;n y en las Pol&' || 'iacute;ticas de Certificados. En este caso el uso del certificado espec&' || 'iacute;ficop ser&' || 'aacute; la firma del contrato con Megadatos SA<br /></p>


<p style="position:absolute;top:781px;left:54px;width:793px;height:275px;text-align: justify" class="ft04"><b>CL&' || 'aacute;USULA CUARTA: CONDICIONES DEL SERVICIO.-</b><br /><b>4.1.- Listas de Certificados Revocados - CRL.-</b> Estar&' || 'aacute;n disponibles las veinte y cuatro horas del d&' || 'iacute;a, durante los trescientos sesenta y cinco d&' || 'iacute;as del a&' || 'ntilde;o, en el sitio web de Security Data Seguridad en Datos y Firma Digital S. A. <a href="https://www.securitydata.net.ec/crl">https://www.securitydata.net.ec/crl</a> Estas Listas ser&' || 'aacute;n actualizadas en forma permanente por la SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A..<br /></p>

<p style="position:absolute;top:891px;left:54px;white-space:nowrap" class="ft04"><b>CL&' || 'aacute;USULA QUINTA: TARIFAS Y FORMA DE PAGO.- </b>Los pagos se realizar&' || 'aacute;n conforme a lo acordado con MegaDatos SA.<br /></p>

<p style="position:absolute;top:927px;left:54px;width:793px;height:275px;text-align: justify" class="ft05"><b>CL&' || 'aacute;USULA SEXTA: OBLIGACIONES DEL SUSCRIPTOR.- </b>Son obligaciones del Suscriptor:<br />
...
6.2. Comunicar a SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. cualquier modificaci&' || 'oacute;n o variaci&' || 'oacute;n de los datos que se aportaron para obtener el Certificado de Firma Electr&' || 'oacute;nica;<br />
6.3. Verificar, a trav&' || 'eacute;s de la Lista de Certificados Revocados, el estado de los Certificados de firma electr&' || 'oacute;nica y la validez de las firmas electr&' || 'oacute;nicas emitidas por SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A.;<br />
6.4. Proteger y conservar con el mayor de los cuidados el Dispositivo, informaci&' || 'oacute;n y/o claves que se entreguen o emitan en relaci&' || 'oacute;n con el certificado de Firma Electr&' || 'oacute;nica;<br />
6.5. Solicitar a SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. de forma personal y/o escrita, en caso de olvido de clave, una nueva clave de protecci&' || 'oacute;n del Certificado de Firma Electr&' || 'oacute;nica;<br />
6.6. Responder por el uso del Certificado de Firma Electr&' || 'oacute;nica y de las consecuencias que se deriven de su utilizaci&' || 'oacute;n; y,<br />
6.7. Las dem&' || 'aacute;s contempladas en la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos y, su Reglamento.<br /></p>

<p style="position:absolute;top:1160px;left:54px;width:793px;height:275px;text-align: justify" class="ft05"><b>CL&' || 'aacute;USULA S&' || 'Eacute;PTIMA: OBLIGACIONES DE SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A..-</b><br />
Son obligaciones de SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A.:<br />
7.1.- Garantizar la prestaci&' || 'oacute;n permanente, inmediata, confidencial, oportuna y segura del servicio de certificaci&' || 'oacute;n de informaci&' || 'oacute;n bajo los dispositivos, claves y/o informaci&' || 'oacute;n relacionada con el certificado de firma electr&' || 'oacute;nica;<br />
7.2.- Mantener sistemas de respaldo de la informaci&' || 'oacute;n relativa a los certificados;<br />
7.3.- Proceder de forma inmediata a la suspensi&' || 'oacute;n o revocatoria de certificados electr&' || 'oacute;nicos previo mandato del Superintendente de Telecomunicaciones, en los casos que se especifiquen en la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas Mensajes de Datos;<br />
7.4.- Mantener una publicaci&' || 'oacute;n del estado de los certificados electr&' || 'oacute;nicos emitidos;<br />
7.5.- Las dem&' || 'aacute;s contempladas en la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos y, su Reglamento.<br />
</p>

<p style="position:absolute;top:1346px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA OCTAVA: RESPONSABILIDADES DE SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A..- </b>SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. ser&' || 'aacute; responsable hasta de la culpa leve y responder&' || 'aacute; por los da&' || 'ntilde;os y perjuicios que cause a cualquier persona natural o jur&' || 'iacute;dica, en el ejercicio de su actividad, cuando incumpla las obligaciones que le impone la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos o act&' || 'uacute;e con negligencia, sin perjuicio de las sanciones previstas en la Ley Org&' || 'aacute;nica de Defensa del Consumidor. Ser&' || 'aacute; tambi&' || 'eacute;n responsable por el uso indebido del certificado de firma electr&' || 'oacute;nica acreditado, cuando no haya consignado en dichos certificados, de forma clara, el l&' || 'iacute;mite de su uso y el importe de las transacciones v&' || 'aacute;lidas que pueda realizar. No ser&' || 'aacute; responsabilidad de SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. el eventual da&' || 'ntilde;o o perjuicio causado por un evento de caso fortuito o fuerza mayor en los t&' || 'eacute;rminos establecidos en el art&' || 'iacute;culo 30 de la Codificaci&' || 'oacute;n del C&' || 'oacute;digo Civil.
</p>

<p style="position:absolute;top:1506px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
<b>CL&' || 'aacute;USULA NOVENA: GARANT&' || 'Iacute;A DE RESPONSABILIDAD.- </b>De conformidad con lo dispuesto en el apartado h) del art&' || 'iacute;culo 30 de la Ley No. 67, SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. cuenta con una garant&' || 'iacute;a de responsabilidad para asegurar a los usuarios el pago de los da&' || 'ntilde;os y perjuicios ocasionados por el incumplimiento de sus obligaciones.<br />
En caso de producirse alg&' || 'uacute;n evento de esta naturaleza, la SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. es responsable hasta por la culpa leve, en este evento, la indemnizaci&' || 'oacute;n ser&' || 'aacute; de hasta el 100% de la tarifa (precio) del Certificado de Firma Electr&' || 'oacute;nica emitido y pagado por el Suscriptor.<br />
El procedimiento de ejecuci&' || 'oacute;n de la Garant&' || 'iacute;a de Responsabilidad, conforme lo previsto en el Reglamento General a la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos, se efectuar&' || 'aacute; de la siguiente forma: Cuando el Suscriptor considere que ha existido incumplimiento en la prestaci&' || 'oacute;n del servicio que le haya ocasionado da&' || 'ntilde;os y perjuicios, este podr&' || 'aacute; presentar a la Secretar&' || 'iacute;a Nacional de Telecomunicaciones, hasta en el t&' || 'eacute;rmino de 15 d&' || 'iacute;as contados desde que se produjo el incumplimiento, una solicitud motivada a fin de que &' || 'eacute;sta:<br />
a) Al amparo de lo dispuesto en el art&' || 'iacute;culo 31 de la Ley No. 67, ponga en conocimiento de SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. el reclamo formulado y solicite que dentro del t&' || 'eacute;rmino perentorio de 5 d&' || 'iacute;as, presente sus descargos o en su defecto reconozca el incumplimiento; y,<br />
b) Vencido el t&' || 'eacute;rmino se&' || 'ntilde;alado en el numeral anterior, la Secretar&' || 'iacute;a Nacional de Telecomunicaciones con o sin la presentaci&' || 'oacute;n de los descargos respectivos por parte de SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A., dentro del t&' || 'eacute;rmino de cinco d&' || 'iacute;as, resolver&' || 'aacute; sobre la procedencia del reclamo formulado por el Suscriptor, el que de ser estimado total o parcialmente dar&' || 'aacute; lugar a que disponga a la compa&' || 'ntilde;&' || 'iacute;a aseguradora la ejecuci&' || 'oacute;n parcial de la garant&' || 'iacute;a de responsabilidad civil por el monto de los da&' || 'ntilde;os y perjuicios causados, los que no podr&' || 'aacute;n reconocerse por un valor superior al establecido en la presente cl&' || 'aacute;usula.<br />
</p>
<p style="position:absolute;top:1836px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMA: EXCLUSI&' || 'Oacute;N DE RESPONSABILIDAD.- </b>SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. no ser&' || 'aacute; responsable por:<br />
1) Da&' || 'ntilde;os y perjuicios cuando El Suscriptor exceda los l&' || 'iacute;mites de uso indicados en el Certificado de Firma Electr&' || 'oacute;nica y en el presente contrato;<br />
2) Ninguna obligaci&' || 'oacute;n, texto y/o en general de todo o parte del contenido de los mensajes de datos vinculados con el certificado que se emita en base a este contrato; tampoco siendo responsable de las consecuencias que se generen por todo o parte del contenido de los se&' || 'ntilde;alados mensajes de datos; y,<br />
...
<p style="position:absolute;top:2000px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
<b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO PRIMERA: SUSPENSI&' || 'Oacute;N.- </b>Se suspender&' || 'aacute;n los Certificados de Firma Electr&' || 'oacute;nica en los siguientes casos:<br />
1. Por disposici&' || 'oacute;n del Consejo Nacional de Telecomunicaciones, de conformidad con lo previsto en la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos;<br />
...
3. Por incumplimiento de los t&' || 'eacute;rminos y condiciones del presente contrato, en especial la que hace relaci&' || 'oacute;n al pago de la retribuci&' || 'oacute;n de SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A.<br />
</p>

<p style="position:absolute;top:2146px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CLAUSULA D&' || 'Eacute;CIMO SEGUNDA: REVOCACI&' || 'Oacute;N.- </b>La revocaci&' || 'oacute;n de los Certificados de Firma Electr&' || 'oacute;nica se realizar&' || 'aacute; seg&' || 'uacute;n los procedimientos descritos en Declaraci&' || 'oacute;n de Practicas de Certificaci&' || 'oacute;n y en las Pol&' || 'iacute;ticas de Certificados.<br />
</p>

<p style="position:absolute;top:2226px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO TERCERA: PROTECCI&' || 'Oacute;N DE INFORMACI&' || 'Oacute;N.- </b>SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. garantiza la protecci&' || 'oacute;n de los datos personales obtenidos en funci&' || 'oacute;n de sus actividades, de conformidad con lo establecido en el art&' || 'iacute;culo 9 de la Ley de Comercio Electr&' || 'oacute;nico, Firmas Electr&' || 'oacute;nicas y Mensajes de Datos.<br />
</p>

<p style="position:absolute;top:2326px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO CUARTA: TERMINACI&' || 'Oacute;N.- </b>Ser&' || 'aacute;n causales de terminaci&' || 'oacute;n del contrato de prestaci&' || 'oacute;n de servicios de Certificaci&' || 'oacute;n de Informaci&' || 'oacute;n las siguientes: <br />
1) La terminaci&' || 'oacute;n del plazo de vigencia del certificado de firma electr&' || 'oacute;nica; <br />
2) La declaraci&' || 'oacute;n unilateral de alguna de las partes contratantes con al menos 15 d&' || 'iacute;as de antelaci&' || 'oacute;n, la cual deber&' || 'aacute; ser comunicada por escrito a la direcci&' || 'oacute;n informada por cada una de las partes en la Cl&' || 'aacute;usula Vig&' || 'eacute;simo Primera de este instrumento legal; <br />
3) Fallecimiento o incapacidad del Suscriptor;<br />
4) Por causa judicialmente declarada; y,<br />
5) Por revocaci&' || 'oacute;n del Certificado de firma electr&' || 'oacute;nica.<br />
</p>

<p style="position:absolute;top:2486px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO QUINTA: VIGENCIA.- </b>El Certificado de Firma Electr&' || 'oacute;nica y por ende este contrato tendr&' || 'aacute; una vigencia de tres d&' || 'iacute;as.<br />
</p>

<p style="position:absolute;top:2546px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO SEXTA: JURISDICCI&' || 'Oacute;N.-</b> Las diferencias que se presenten entre las partes con ocasi&' || 'oacute;n de la interpretaci&' || 'oacute;n o ejecuci&' || 'oacute;n de este contrato ser&' || 'aacute;n resueltas mediante arbitraje administrado por el Centro de Mediaci&' || 'oacute;n y Arbitraje de la C&' || 'aacute;mara de Comercio de Guayaquil.<br />
La legislaci&' || 'oacute;n aplicable a este contrato es, bajo el procedimiento CNUDMI (UNCITRAL).<br />
</p>

<p style="position:absolute;top:2646px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO SEPTIMA.- AUTORIZACI&' || 'Oacute;N.-</b> El Suscriptor autoriza a SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A. a:<br />
1) Conservar y hacer uso de toda la documentaci&' || 'oacute;n o dem&' || 'aacute;s informaci&' || 'oacute;n que se le ha entregado con la solicitud o que le entregue en el futuro, independientemente de la aceptaci&' || 'oacute;n o rechazo de la misma. En especial la solicitud que ha presentado el Suscriptor y los documentos anexos a esta.<br />
2) Verificar toda la informaci&' || 'oacute;n entregada a trav&' || 'eacute;s de los medios que se estime pertinentes.<br />
</p>


<p style="position:absolute;top:2786px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    <b>CL&' || 'aacute;USULA D&' || 'Eacute;CIMO OCTAVA.- DECLARACI&' || 'Oacute;N.-</b> El Suscriptor, por el presente instrumento, declara que recibe <b>un certificado de firma electr&' || 'oacute;nica en archivo,</b> a su entera satisfacci&' || 'oacute;n, y se compromete a dar estricto cumplimiento a las obligaciones y recomendaciones previstas en el presente contrato y a cuidar este hardware y/o software con sumo cuidado.<br />
</p>

<p style="position:absolute;top:2906px;left:54px;width:793px;height:275px;text-align: justify" class="ft05">
    El Suscriptor declara, adem&' || 'aacute;s, haber recibido toda la informaci&' || 'oacute;n necesaria sobre los certificados que expide SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A., su nivel de confiabilidad, los l&' || 'iacute;mites de responsabilidad, y las obligaciones que asume como Suscriptor del servicio de certificaci&' || 'oacute;n de informaci&' || 'oacute;n. As&' || 'iacute; tambi&' || 'eacute;n, manifiesta que conoce y ha le&' || 'iacute;do las Declaraciones de Pr&' || 'aacute;cticas de Certificaci&' || 'oacute;n y dem&' || 'aacute;s normas emitidas por la SECURITY DATA SEGURIDAD EN DATOS Y FIRMA DIGITAL S. A., que se encuentran disponibles en la p&' || 'aacute;gina web <a href="https://www.securitydata.net.ec">https://www.securitydata.net.ec</a> Entidad de Certificaci&' || 'oacute;n.
</p>


<p style="position:absolute;top:3020px;left:134px;white-space:nowrap" class="ft05">(fecha de emisi&' || 'oacute;n):<input type="text" name="fecha" id="fecha" value="$fechaActual"/></p>
<!--p style="position:absolute;top:3186px;left:134px;white-space:nowrap" class="ft05">------------------------------------------&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;----------------------------------&#160;&#160;&#160;&#160;</p-->

<p style="position:absolute;top:3292px;left:134px;white-space:nowrap" class="ft04"><b>SECURITY DATA SEGURIDAD EN</b></p>
<p style="position:absolute;top:3304px;left:134px;white-space:nowrap" class="ft04"><b>DATOS Y FIRMA DIGITAL S. A.</b></p>
<p style="position:absolute;top:3303px;left:512px;white-space:nowrap" class="ft04"><b>EL SUSCRIPTOR</b></p>
...
dbms_output.put_line('Contrato Security Data '||dbms_lob.getlength(bada));
...
<p style="position:absolute;top:235px;left:559px;white-space:nowrap" class="ft01">Fecha:<input type="text" id="fecha" name="fecha" size="32" required value="$fechaActual"></p>
...
<p style="position:absolute;top:274px;left:94px;white-space:nowrap" class="ft01">Nombres y Apellidos*:<input type="text" id="nombres" name="nombres" size="86" value="$nombresApellidos" required></p>
<p style="position:absolute;top:299px;left:94px;white-space:nowrap" class="ft01">No. C&' || 'eacute;dula / No. Pasaporte*:<input type="text" id="cedula" name="cedula" size="38" value="$identificacion" required></p>
<p style="position:absolute;top:299px;left:559px;white-space:nowrap" class="ft01">Nacionalidad*:<input type="text" id="nacionalidad" name="nacionalidad" size="25" value="$nacionalidad" required></p>
<p style="position:absolute;top:324px;left:94px;white-space:nowrap" class="ft01">Email*:<input type="text" id="email" name="email" size="97" value="$emailCliente" required></p>
...
<p style="position:absolute;top:414px;left:94px;white-space:nowrap" class="ft01">Direcci&' || 'oacute;n*:<input type="text" id="direccion" name="direccion" size="93" value="$direccion" required></p>
<p style="position:absolute;top:438px;left:94px;white-space:nowrap" class="ft01">Provincia*:<input type="text" id="provincia" name="provincia" size="38" value="$provincia" required></p>
<p style="position:absolute;top:438px;left:459px;white-space:nowrap" class="ft01">Ciudad*:<input type="text" id="ciudad" name="ciudad" size="43" value="$ciudad" required></p>
<p style="position:absolute;top:463px;left:94px;white-space:nowrap" class="ft01">Tel&' || 'eacute;fono*:<input type="text" id="telefono" name="telefono" size="39" value="$telefono" required></p>
<p style="position:absolute;top:463px;left:459px;white-space:nowrap" class="ft01">Celular:<input type="text" id="celular" name="celular" size="44" value="$celular"></p>
<p style="position:absolute;top:502px;left:94px;white-space:nowrap" class="ft02"><b>3. Tiempo de validez del certificado</b></p>
<p style="position:absolute;top:542px;left:180px;white-space:nowrap" class="ft01"><input type="radio" name="mes"  checked="$validezCertificadoCheck" />&' || 'nbsp;&' || 'nbsp;a. 3 d&' || 'iacute;as</p>
<p style="position:absolute;top:600px;left:94px;white-space:nowrap" class="ft02"><b>4. Uso del Certificado</b></p>
<p style="position:absolute;top:640px;left:180px;white-space:nowrap" class="ft01"><input type="checkbox" name="uso" value="$usoCertificadoCheck"  style="color: black;background-color: black" checked="checked" />&' || 'nbsp;&' || 'nbsp;a. Firma de contrato con MEGADATOS</p>

<!--p style="position:absolute;top:690px;left:94px;" class="ft05">El&#160;solicitante&#160;declara&#160;que&#160;voluntaria&#160;y&#160;libremente&#160;acepta&#160;todos&#160;los&#160;t&' || 'eacute;rminos&#160;y&#160;condiciones&#160;expresados&#160;en&#160;este&#160;documento,&#160;en&#160;la&#160;DPC&#160;y&#160;en&#160;la&#160;Pol&' || 'iacute;tica&#160;de&#160;<br/>Certificaci&' || 'oacute;n del&#160;certificado&#160;solicitado,&#160;los&#160;cuales&#160;ha&#160;revisado&#160;detalladamente&#160;y&#160;no&#160;alberga&#160;duda&#160;alguna.&#160;En&#160;prueba&#160;de&#160;conformidad&#160;firma&#160;el&#160;documento;&#160;<br/>adem&' || 'aacute;s&#160;corrobora&#160;que&#160;la&#160;informaci&' || 'oacute;n&#160;entregada&#160;y&#160;declarada&#160;a&#160;Security&#160;Data&#160;es&#160;real;&#160;en&#160;caso&#160;de&#160;descubrirse&#160;falsedad&#160;en&#160;las&#160;declaraciones&#160;o&#160;<br/>documentaciones&#160;aqu&' || 'iacute;&#160;presentadas&#160;Security&#160;Data&#160;realizar&' || 'aacute;&#160;las&#160;respectivas&#160;denuncias&#160;ante&#160;la&#160;autoridad&#160;competente.&#160;</p-->
<p style="position:absolute;top:690px;left:94px;width:718px;height:1188px;text-align: justify" class="ft05">
    El solicitante declara que voluntaria y libremente acepta todos los t&' || 'eacute;rminos y condiciones expresados en este documento, en la DPC y en la Pol&' || 'iacute;tica de
Certificaci&' || 'oacute;n del certificado solicitado, los cuales ha revisado detalladamente y no alberga duda alguna. En prueba de conformidad firma el documento;
adem&' || 'aacute;s corrobora que la informaci&' || 'oacute;n entregada y declarada a Security Data es real; en caso de descubrirse falsedad en las declaraciones o
documentaciones aqu&' || 'iacute; presentadas Security Data realizar&' || 'aacute; las respectivas denuncias ante la autoridad competente.
</p>
<p style="position:absolute;top:764px;left:94px;white-space:nowrap" class="ft00"><b>FIRMA DEL SUSCRIPTOR</b></p>
</div>
</body>
</html>');

dbms_output.put_line('Formulario Security Data '||dbms_lob.getlength(bada));
            ...
            <div id="row">
				<div id="colCell" class="col-width-30" style="text-align:center">
                    <div id="contenedor" class="col-width-80">
                        ...
                        <div id="row">
                            <div id="colCell" class="col-width-10"></div>
                            <div id="colCell" class="col-width-20">Firma del Cliente</div>
                            <div id="colCell" class="col-width-20"></div>
                        </div>
                    </div>
                </div>
...
dbms_output.put_line('Debito Megadatos '||dbms_lob.getlength(bada));
	...
	<body>
        ...
        <div id="contenedor" class="col-width-100">            <div id="row">
                ...
                <div id="col" class="col-width-5 labelGris">
					<span class="textPadding">$!valorPlanNumeros</span>
				</div>
        ...
        <div id="contenedor" class="col-width-100">
            <div id="row">
                ...
                <div id="colCell" class="col-width-50">
                    <div id="contenedor" class="col-width-100">
                        <div id="row" >
                            <div id="col" class="col-width-25">Firma:</div>
...
dbms_output.put_line('Pagare Megadatos '||dbms_lob.getlength(bada));
