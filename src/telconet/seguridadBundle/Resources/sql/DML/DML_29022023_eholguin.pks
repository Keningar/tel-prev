...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. Grupo 7
 * @version 1.0
...
DECLARE
   ...
   CURSOR C_GetDepartamentos(Cv_PrefijoEmpresa   DB_COMERCIAL.INFO_EMPRESA_GRUPO.PREFIJO%TYPE )
    IS
        ...
        IN('Operaciones Urbanas','Tecnica Sucursal') 
   ...
   IS
	...
	'Jefe Cuadrilla','Jefe Cuadrilla Motorizado','JEFE DE CUADRILLA MOTORIZADO','Tecnico Jr.','Tecnico Sr.','Ayudante Tecn. Electrico','Ayudante Tecnico','Ayudante Tecn. Motorizado','Ingeniero Jr. 1')
