...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. Grupo 2 
 * @version 1.0
...
DECLARE
   ...
   CURSOR C_GetDepartamentos(Cv_PrefijoEmpresa   DB_COMERCIAL.INFO_EMPRESA_GRUPO.PREFIJO%TYPE )
    IS
        ...
        IN('GIS','Operaciones Urbanas','Tecnica Sucursal','GERENCIA TECNICA NACIONAL') 
   ...
   IS
	...
	'Asistente',
	'Coordinador',
    'Coord. Infraestru Ope Urb',
    'Coord. Zonal Oper. Urb.',
    'Tecnólogo Jr.',
	'Dibujante Tecnico',
	'Dibujante Técnico',
    ...
    'Subgerente Tecnico Prov.',
	'Ayudante Coordinador',
    'Ayudante Tecnico',
	'Jefatura departamental',
	'Jefe Dpto Nacional',
	'Jefe Dpto. Nacional',
	'Jefe Tecnico Sucursal',
    'Jefe Técnico Sucursal',
    'Jefe Nacional Redes Lan',
    'Gerente Tecnico Sucursal',
    'Gerente Area Nacional')
