...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. Grupo 5
 * @version 1.0
...
DECLARE
   ...
   IS
    ...
    'Jefe Departamental',
	'Supervisor Obras Civiles') AND AR.ESTADO   <> 'Eliminado';
