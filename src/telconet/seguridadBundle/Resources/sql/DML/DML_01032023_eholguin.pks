...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. 
 * @version 1.0
...
DECLARE
   ...
   CURSOR C_GetDepartamentos(Cv_PrefijoEmpresa   DB_COMERCIAL.INFO_EMPRESA_GRUPO.PREFIJO%TYPE )
    IS
        ...
        IN('GIS','Operaciones Urbanas','Tecnica Sucursal') 
   ...
   IS
	...
	'Asistente Administrativa',
        ...
        'Coord. Instalación Op Urb',
        'Jefe Operativo',
	'Coord. Logisitica Oper Ur',
	'Coordinador Insta Agenc',
	'Jefe De sucursal')
