...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. Grupo 4.
 * @version 1.0
...
DECLARE
   ...
   IS
	...
	'Fiscalizador',
	'Fiscalizador Motorizado') AND AR.ESTADO   <> 'Eliminado';
