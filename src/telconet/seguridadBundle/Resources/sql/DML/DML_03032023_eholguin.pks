...
/**
 * Script de regularización y asignación de perfiles a empleados según el cargo enviado como parámetro. Grupo 3
 * @version 1.0
...
DECLARE
   ...
   IS
	...
	'Coord Infraetructura Fo') AND AR.ESTADO   <> 'Eliminado';
