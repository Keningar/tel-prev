...
Ext.onReady(function() {
    ...
    Ext.define('ModelStore', {
        ...
        [
            ...
            {name:'es_capital', mapping:'es_capital'},
            {name:'es_cabecera', mapping:'es_cabecera'},
            {name:'estado', mapping:'estado'},
            {name:'sigla', mapping:'sigla'},
            {name:'codigoInec', mapping:'codigoInec'},
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                ...
                {
                  id: 'es_capital',
                  header: 'Es Capital Provincial',
                  dataIndex: 'es_capital',
                  width: 120,
                  sortable: true
                },
                {
                  id: 'es_cabecera',
                  header: 'Es Cabecera Cantonal',
                  dataIndex: 'es_cabecera',
                  width: 120,
                  sortable: true
                },
                {
                    ...
                    items: [{
                        getClass: function(v, meta, rec) {
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                ...
                                if(rec.get('action1')!="icon-invisible")
                                    window.location = rec.get('id_canton')+"/show";
                                else
                        ...
                        },
                        {
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                ...
                                if(rec.get('action2')!="icon-invisible")
                                    window.location = rec.get('id_canton')+"/edit";
                                else
                                    Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
                            }
                        },
                                    ...
                                    Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
                                        if(btn=='yes'){
                                            Ext.Ajax.request({
                                                url: "deleteAjax",
                                                method: 'post',
                                                params: { param : rec.get('id_canton')},
