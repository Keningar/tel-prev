...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
		...
		[				
			...
			{name:'codigo_tipo_negocio', mapping:'codigo_tipo_negocio'},
			{name:'nombre_tipo_negocio', mapping:'nombre_tipo_negocio'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}               
		],
        idProperty: 'id_tipo_negocio'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_tipo_negocio',
                  header: 'IdTipoNegocio',
                  dataIndex: 'id_tipo_negocio',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'codigo_tipo_negocio',
                  header: 'Codigo Tipo Negocio',
                  dataIndex: 'codigo_tipo_negocio',
                  width: 120,
                  sortable: true
                },
                {
                  id: 'nombre_tipo_negocio',
                  header: 'Nombre Tipo Negocio',
                  dataIndex: 'nombre_tipo_negocio',
                  width: 350,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_tipo_negocio')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_tipo_negocio')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_tipo_negocio')},
