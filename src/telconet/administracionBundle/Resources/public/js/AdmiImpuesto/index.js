...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[		
			{name:'id_impuesto', mapping:'id_impuesto'},
			{name:'tipo_impuesto', mapping:'tipo_impuesto'},
			{name:'descripcion_impuesto', mapping:'descripcion_impuesto'},
			{name:'codigo_sri', mapping:'codigo_sri'},
			{name:'porcentaje_impuesto', mapping:'porcentaje_impuesto'},
			{name:'fecha_vigencia_impuesto', mapping:'fecha_vigencia_impuesto'},
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                ...
                {
                  id: 'descripcion_impuesto',
                  header: 'Descripcion',
                  dataIndex: 'descripcion_impuesto',
                  width: 300,
                  sortable: true
                },
                {
                ...
                {
                  id: 'fecha_vigencia_impuesto',
                  header: 'Fecha Vigencia',
                  dataIndex: 'fecha_vigencia_impuesto',
                  width: 120,
                  sortable: true
                },            
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_impuesto')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_impuesto')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_impuesto')},
