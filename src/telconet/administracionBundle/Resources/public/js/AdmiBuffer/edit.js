Ext.onReady(function(){
    //funcion para cargar el valor de clase tipo medio
    cargarClaseTipoMedio();
    ...
    var storeBufferHiloData = new Ext.data.Store({ 
        total: 'total',
        autoLoad:true,
        proxy: {
            type: 'ajax',
        ...
        fields:
              [
                ...
                {name:'hiloNumeroColor', mapping:'hiloNumeroColor'},
                {name:'bufferHiloId',    mapping:'bufferHiloId'}
              ]
    });
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                handler : function(){
                    ...
                    if(!existeRecordHilo(r, gridBufferHilo))
                    {
                        storeBufferHiloData.insert(0, r);
...
function cargarClaseTipoMedio()
{
 var conn = new Ext.data.Connection();
 conn.request
      (
        {
          url: getClaseTipoMedioPorBuffer,
          method: 'post',
          params: {
              estado: 'Activo'
          },
          success: function(response)
                   {
                     ...
                     agregarValue("telconet_schemabundle_admibuffertype_claseTipoMedioId", json.encontrados[0]['idClaseTipoMedio']);
                   },
