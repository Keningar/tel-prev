Ext.onReady(function(){
    ...
    var cellEditing = Ext.create('Ext.grid.plugin.CellEditing', {
        ...
        listeners: {
            edit: function(){
                // refresh summaries
                gridTecnologias.getView().refresh();
            }
        }
    });
    ...
    var selTecnologias = Ext.create('Ext.selection.CheckboxModel', {
        listeners: {
            selectionchange: function(sm, selections) {
                gridTecnologias.down('#removeButton').setDisabled(selections.length == 0);
            }
        }
    });
    
    //grid de tecnologias
    gridTecnologias = Ext.create('Ext.grid.Panel', {
        id:'gridTecnologias',
            ...
            editor: {
                ...
                listeners: {
                    select: function(combo){
                        ...
                        if(!existeRecordTecnologia(r, gridTecnologias))
                        {
                        ...
                        {
                            alert('Ya existe');
                            eliminarSeleccion(gridTecnologias);
                        }
                    }
                }
            }
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                iconCls:'remove',
                disabled: true,
                handler : function(){eliminarSeleccion(gridTecnologias);}
            }, '-', {
                text:'Agregar',
                tooltip:'Agrega un item a la lista',
                iconCls:'add',
...
function selecionarTipoElemento() 
{
  ...
  //Verificamos que el tipo de elemento seleccionado sea una camara safecity valida
  ...
  if (boolCamaraValida) 
  {
    ...
    $.ajax({
      ...
      success: function (tipoCamara) {
        const arrayTipoCamara = JSON.parse(tipoCamara);
