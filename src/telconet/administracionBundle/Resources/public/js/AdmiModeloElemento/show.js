...
{
  const comboTipoElemento = document.getElementById("tipoElemento"); //id tomado desde la etiqueta HTML
  const tipoElemento = comboTipoElemento.innerText;
  ...
  if (boolCamaraValida) 
  {
    $.ajax({
      type: "GET",
      data: {
        modeloElemento: document.getElementById("modeloElemento").innerText,
      },
      url: "getParametrosDetCamaras",
      success: function (parametros) {
        //Obtenemos los valores de tipoCamara y  resolucion que pertenecen al modelo
        ...
        if (arrayParametro.length!== 0) 
        {
          ...
          comboTipoCamara.innerText = arrayParametro.tipo;
          comboResolucionCamara.innerText = arrayParametro.resolucionAlterna;
        }
      },
    });
  }
