...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[				
			{name:'id_clausula_contrato', mapping:'id_clausula_contrato'},
			{name:'nombre_clausula', mapping:'nombre_clausula'},
        ...
        idProperty: 'id_clausula_contrato'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_clausula_contrato',
                  header: 'IdClausulaContrato',
                  dataIndex: 'id_clausula_contrato',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombre_clausula',
                  header: 'Nombre Clausula',
                  dataIndex: 'nombre_clausula',
                  width: 300,
                  sortable: true
                },
                {
                ...
                },
                {
                    ...
                    items: [{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_clausula_contrato')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_clausula_contrato')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion'); 
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_clausula_contrato')},
