...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[				
			{name:'id_tipo_notificacion', mapping:'id_tipo_notificacion'},
			{name:'nombre_tipo_notificacion', mapping:'nombre_tipo_notificacion'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}                
		],
        idProperty: 'id_tipo_notificacion'
    });
        ...
        columns:[
                {
                  ...
                  header: 'IdTipoNotificacion',
                  dataIndex: 'id_tipo_notificacion',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombre_tipo_notificacion',
                  header: 'Nombre Tipo Notificacion',
                  dataIndex: 'nombre_tipo_notificacion',
                  width: 300,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_tipo_notificacion')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_tipo_notificacion')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_tipo_notificacion')},
