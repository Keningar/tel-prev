...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[				
			{name:'id_tipo_comunicacion', mapping:'id_tipo_comunicacion'},
			{name:'nombre_tipo_comunicacion', mapping:'nombre_tipo_comunicacion'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}                
		],
        idProperty: 'id_tipo_comunicacion'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_tipo_comunicacion',
                  header: 'id_tipo_comunicacion',
                  dataIndex: 'id_tipo_comunicacion',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombre_tipo_comunicacion',
                  header: 'Nombre Tipo Comunicacion',
                  dataIndex: 'nombre_tipo_comunicacion',
                  width: 500,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_tipo_comunicacion')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_tipo_comunicacion')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_tipo_comunicacion')},
