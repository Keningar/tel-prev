...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        idProperty: 'id_nivel_criticidad'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_nivel_criticidad',
                  header: 'IdNivelCriticidad',
                  dataIndex: 'id_nivel_criticidad',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombre_nivel_criticidad',
                  header: 'Nombre Nivel Criticidad',
                  dataIndex: 'nombre_nivel_criticidad',
                  width: 300,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_nivel_criticidad')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_nivel_criticidad')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_nivel_criticidad')},
