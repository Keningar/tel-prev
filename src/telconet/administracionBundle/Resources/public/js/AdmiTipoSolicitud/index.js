...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
		...
		[				
			...
			{name:'descripcion_tipo_solicitud', mapping:'descripcion_tipo_solicitud'},
			{name:'nombreProceso', mapping:'nombreProceso'},
			{name:'nombreTarea', mapping:'nombreTarea'},
			{name:'nombreItemMenu', mapping:'nombreItemMenu'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}                
		],
        idProperty: 'id_tipo_solicitud'
    });
        ...
        columns:[
                {
                  ...
                  header: 'IdTipoSolicitud',
                  dataIndex: 'id_tipo_solicitud',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'descripcion_tipo_solicitud',
                  header: 'Descripcion Tipo Solicitud',
                  dataIndex: 'descripcion_tipo_solicitud',
                  width: 300,
                  sortable: true
                },
                {
                ...
                {
                  id: 'nombreItemMenu',
                  header: 'Nombre Item Menu',
                  dataIndex: 'nombreItemMenu',
                  width: 250,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_tipo_solicitud')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_tipo_solicitud')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_tipo_solicitud')},
