...
function buscar(){
    store.getProxy().extraParams.numeroHilo = Ext.getCmp('txtNumero').value;
    store.getProxy().extraParams.colorHilo  = Ext.getCmp('txtColor').value;
