...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[		
			{name:'id_titulo', mapping:'id_titulo'},
			{name:'codigo_titulo', mapping:'codigo_titulo'},
			{name:'descripcion_titulo', mapping:'descripcion_titulo'},
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                ...
                {
                  id: 'codigo_titulo',
                  header: 'Codigo Titulo',
                  dataIndex: 'codigo_titulo',
                  width: 100,
                  sortable: true
                },
                {
                  id: 'descripcion_titulo',
                  header: 'Descripcion Titulo',
                  dataIndex: 'descripcion_titulo',
                  width: 200,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_titulo')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_titulo')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_titulo')},
