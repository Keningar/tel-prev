        ...
        columns:[
                {
                  ...
                  header: 'id_clase_documento',
                  dataIndex: 'id_clase_documento',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombre_clase_documento',
                  header: 'Nombre Clase Documento',
                  dataIndex: 'nombre_clase_documento',
                  width: 500,
                  sortable: true
                },
		{
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_clase_documento')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_clase_documento')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_clase_documento')},
