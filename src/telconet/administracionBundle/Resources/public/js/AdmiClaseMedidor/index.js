...
Ext.onReady(function() { 
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'idClaseMedidor',
                  header: 'idClaseMedidor',
                  dataIndex: 'idClaseMedidor',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'nombreClaseMedidor',
                  header: 'Nombre Clase Medidor',
                  dataIndex: 'nombreClaseMedidor',
                  width: 200,
                  sortable: true
                },
                {
                ...
                },
                {
                    ...
                    items: [{
	                        getClass: function(v, meta, rec) {
                                    var permiso = '{{ is_granted("ROLE_85-6") }}';
				    ...
				    var permiso = '{{ is_granted("ROLE_85-6") }}';
                                    ...
                                    if(rec.get('action1')!="icon-invisible")
                                            window.location = rec.get('idClaseMedidor')+"/show";
                                    else
                        ...
                        {
                                getClass: function(v, meta, rec) {
                                    var permiso = '{{ is_granted("ROLE_85-4") }}';
                                    var boolPermiso = (typeof permiso === 'undefined') ? false : (permiso ? true : false);							
                                ...
                                handler: function(grid, rowIndex, colIndex) {
                                    ...
                                    var boolPermiso = (typeof permiso === 'undefined') ? false : (permiso ? true : false);							
                                        ...
                                        if(rec.get('action2')!="button-grid-invisible")
                                                window.location = ""+rec.get('idClaseMedidor')+"/edit";
                                        else
                                                Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion'); 
                                }
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "delete",
	                                            method: 'post',
	                                            params: { param : rec.get('idClaseMedidor')},
            ...
            buttons: [
                ...
                items: [
                        { width: '10%',border:false},
                        {
                            xtype: 'textfield',
                            id: 'txtNombre',
                            fieldLabel: 'Nombre Clase Medidor',
                            value: '',
                            width: '200px'
                        },
