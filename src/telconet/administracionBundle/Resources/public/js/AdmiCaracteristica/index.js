...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[				
			{name:'id_caracteristica', mapping:'id_caracteristica'},
			{name:'descripcion_caracteristica', mapping:'descripcion_caracteristica'},
			{name:'tipoIngreso', mapping:'tipoIngreso'},
        ...
        columns:[
                {
                  ...
                  header: 'IdCaracteristica',
                  dataIndex: 'id_caracteristica',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'descripcion_caracteristica',
                  header: 'Descripcion Caracteristica',
                  dataIndex: 'descripcion_caracteristica',
                  width: 485,
                  sortable: true
                },
                {
                ...
                },
                {
                    ...
                    items: [{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_caracteristica')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_caracteristica')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_caracteristica')},
