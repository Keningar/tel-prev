...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
        ...
        fields:
		[				
			{name:'id_tipo_contrato', mapping:'id_tipo_contrato'},
			{name:'nombre_empresa', mapping:'nombre_empresa'},
			{name:'descripcion_tipo_contrato', mapping:'descripcion_tipo_contrato'},
			{name:'tiempo_finalizacion', mapping:'tiempo_finalizacion'},
			{name:'tiempo_alerta_finalizacion', mapping:'tiempo_alerta_finalizacion'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}                 
		],
        idProperty: 'id_tipo_contrato'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_tipo_contrato',
                  header: 'IdTipoContrato',
                  dataIndex: 'id_tipo_contrato',
                  hidden: true,
                  hideable: false
                },
                {
                ...
                {
                  id: 'descripcion_tipo_contrato',
                  header: 'Descripcion Tipo Contrato',
                  dataIndex: 'descripcion_tipo_contrato',
                  width: 240,
                  sortable: true
                },
                {
                  id: 'tiempo_finalizacion',
                  header: 'Tiempo Finalizacion',
                  dataIndex: 'tiempo_finalizacion',
                  width: 130,
                  sortable: true
                },
                {
                  id: 'tiempo_alerta_finalizacion',
                  header: 'Tiempo Alerta Finalizacion',
                  dataIndex: 'tiempo_alerta_finalizacion',
                  width: 150,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_tipo_contrato')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_tipo_contrato')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_tipo_contrato')},
