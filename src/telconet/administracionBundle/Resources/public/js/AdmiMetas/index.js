...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
		...
		[				
            ...
            {name:'METABS', mapping:'METABS'},
			{name:'VALOR_MRC', mapping:'VALOR_MRC'},
			{name:'VALOR_NRC', mapping:'VALOR_NRC'},
