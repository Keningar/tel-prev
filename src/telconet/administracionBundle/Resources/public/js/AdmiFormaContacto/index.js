...
Ext.onReady(function() { 
    ...
    Ext.define('ModelStore', {
		...
		[				
			...
			{name:'descripcion_forma_contacto', mapping:'descripcion_forma_contacto'},
			{name:'estado', mapping:'estado'},
			{name:'action1', mapping:'action1'},
			{name:'action2', mapping:'action2'},
			{name:'action3', mapping:'action3'}                
		],
        idProperty: 'id_forma_contacto'
    });
    ...
    grid = Ext.create('Ext.grid.Panel', {
        ...
        columns:[
                {
                  id: 'id_forma_contacto',
                  header: 'IdFormaContacto',
                  dataIndex: 'id_forma_contacto',
                  hidden: true,
                  hideable: false
                },
                {
                  id: 'descripcion_forma_contacto',
                  header: 'Descripcion Forma Contacto',
                  dataIndex: 'descripcion_forma_contacto',
                  width: 400,
                  sortable: true
                },
                {
                    ...
                    items: [
						{
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
								...
								if(rec.get('action1')!="icon-invisible")
									window.location = rec.get('id_forma_contacto')+"/show";
								else
                        ...
                        },
                        {
	                        ...
	                        handler: function(grid, rowIndex, colIndex) {
	                            ...
	                            if(rec.get('action2')!="icon-invisible")
	                                window.location = rec.get('id_forma_contacto')+"/edit";
								else
									Ext.Msg.alert('Error ','No tiene permisos para realizar esta accion');
							}
                        },
	                                ...
	                                Ext.Msg.confirm('Alerta','Se eliminara el registro. Desea continuar?', function(btn){
	                                    if(btn=='yes'){
	                                        Ext.Ajax.request({
	                                            url: "deleteAjax",
	                                            method: 'post',
	                                            params: { param : rec.get('id_forma_contacto')},
