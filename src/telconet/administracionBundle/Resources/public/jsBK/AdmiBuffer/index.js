Ext.onReady(function() {    
    ...
    var storeTiposMedios = new Ext.data.Store({ 
        total: 'total',
        autoLoad:true,
        proxy: {
            type: 'ajax',
            url : '../../tecnico/admi_tipo_medio/getTiposMedios',
            reader: {
                type: 'json',
                totalProperty: 'total',
                root: 'encontrados'
...
function buscar(){
    ...
    store.getProxy().extraParams.tipoMedio = Ext.getCmp('sltTipoMedio').value;
...
function eliminarAlgunos(){
    ...
    if(sm.getSelection().length > 0)
    {
      ...
      {
        param = param + sm.getSelection()[i].data.idBuffer;
