...
class DetencionSuspTratamientoController extends Controller implements TokenAuthenticatedController
{
    /**
     * 
     *
     * Documentación para el método 'indexAction'.
     * Muestra la pagina principal del modulo de DetencionSuspTratamiento en Derechos del Titular
     *
     * @return Response.
     *
    ...
    public function indexAction()
    {
        ...
        $entityItemMenu = $objEmSeguridad->getRepository('schemaBundle:SeguRelacionSistema')->searchItemMenuByModulo("495", "1");    	
