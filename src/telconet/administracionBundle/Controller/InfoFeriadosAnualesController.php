...
use telconet\schemaBundle\Entity\InfoFeriadosAnuales;
use telconet\schemaBundle\Repository\InfoFeriadosAnualesRepository;
...
class InfoFeriadosAnualesController extends Controller 
{ 
    /**
     * Funcion que sirve para mostrar la pantalla principal de feriados anuales
     * 
    ...
    public function indexAction()
    {
        ...
        return $this->render('administracionBundle:InfoFeriadosAnuales:index.html.twig', array(
    ...
    *
    * Metodo utilizado para mostrar el grid de la administracion de Feriados anuales
    *
    * @author Edgar Pin Villavicencio <epin@telconet.ec>          
    * @version 1.0 12-12-2018
    */    
    public function gridAction()
    {
        ...
        $intAnio            = $objPeticion->get('anio');

        $arrayDatosBusqueda    = array();
        $arrayDatosBusqueda['intStart'] = 0;
        $arrayDatosBusqueda['intLimit'] = 99999999;
        $arrayDatosBusqueda['intAnio']  = $intAnio;
        
               
        try
        {
            $objJson = $this->getDoctrine()->getManager("telconet_general")
                                           ->getRepository('schemaBundle:InfoFeriadosAnuales')
                                           ->generarJsonFeriadosAnuales($arrayDatosBusqueda);
        }
        catch(\Exception $ex)
        {
            $serviceUtil->insertError('Telcos+', 'InfoFeriadosAnualesController->gridAction', $ex->getMessage(), $strUsrCreacion, $strIpClient);
        }
    ...
    */
    ...
    {
        return $this->render('administracionBundle:InfoFeriadosAnuales:new.html.twig',
