...
class ProteccionDatosCifrarController extends Controller implements TokenAuthenticatedController
{ 
     /**
     * @Secure(roles="ROLE_499-1")
     *
    ...
    public function indexAction()
    {
        ...
        return $this->render('administracionBundle:DerechoTitular:index.html.twig', []);
    }
     ...
     * @version 1.0 Version Inicial
     */
    public function cifrarClienteAction()
    {
        $objResponse                                  = new JsonResponse();
        ...
        $objDerechoTitular                            = $this->get('administracion.DerechoTitular');
        $arrayRespuesta                               = $objDerechoTitular->cifrarCliente($arrayParametros);
        $objResponse->setData( $arrayRespuesta );
        return $objResponse;
    }
