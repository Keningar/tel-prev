...
function obtenerHipotesis()
{
  ...
  var nombre = gridHipotesis.getStore().getAt(0).data['nombre_hipotesis'];
  cont=0;
...
function agregarArbolHipotesis(rec, id_caso){
	...
	//variable storeArbolHipotesisNivel1, 2 y 3 
	//estan declarados en soporteBundle/Resources/public/js/InfoCaso/general.js
