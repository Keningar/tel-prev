    ...
    tpl: [
        '<div class="details">',
            '<tpl for=".">',
				'<br/>',
				(!Ext.isIE6? 
				'<div align="center" ><img src="/public/uploads/imagesPlantilla/media/{thumb}" width="200" height="200" /></div>' : 
				'<div style="width:74px;height:74px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/public/uploads/imagesPlantilla/media/{thumb}\')"></div>'),
				'<br/><br/>',
                '<div class="details-info">',
                    ...
                    '<b>URL Imagen: </b>',
                    '<span><a href="https://telcos.telconet.ec/{url}" target="_blank">{url}</a></span>',
                '</div>',
            '</tpl>',
        '</div>'
    ],
