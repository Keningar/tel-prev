    ...
    getItemConfigs: function() {
        ...
        return [{
            ...
            items: [
                ...
                //**************************************************
                { boxLabel: 'Dom', name: 'SU', id: id + '-SU' },
                { boxLabel: 'Lun', name: 'MO', id: id + '-MO' },
                { boxLabel: 'Mar', name: 'TU', id: id + '-TU' },
                { boxLabel: 'Mie', name: 'WE', id: id + '-WE' },
                { boxLabel: 'Jue', name: 'TH', id: id + '-TH' },
                { boxLabel: 'Vie', name: 'FR', id: id + '-FR' },
                { boxLabel: 'Sab', name: 'SA', id: id + '-SA' }
            ],
            listeners: {
...
Extensible.calendar.data.EventMappings = {
    ...
    NombreAsignado: {
        name:       'NombreAsignado',
        mapping:    'nombreAsignado',
        type:       'string'
    },
    NombreAsignadoPor: {
        name:       'NombreAsignadoPor',
        mapping:    'nombreAsignadoPor',
        type:       'string'
    },
    Estado: {
        name:       'Estado',
...
Ext.define('Extensible.calendar.form.EventDetails', {
    ...
    titleTextEdit: 'Mostrar Evento',
    titleLabelText: 'Titulo',
    datesLabelText: 'Fechas',
    reminderLabelText: 'Reminder',
    notesLabelText: 'Notas',
    locationLabelText: 'Localizacion',
    webLinkLabelText: 'Link Pagina',
...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    savingMessage: 'Grabando Cambios...',
    ...
    show: function(o, animateTarget){
        if (o.data) {
         ...
         //   alert(o.data.Id);
			...
			btnguardar = Ext.create('Ext.Button', {
				...
				handler: function() {
					conn.request({
						...
						url: '../info_caso/administrarTareaAsignada',
			...
			string_html += "                <tr style='height:320px'>";
			...
			var string_html_data  = "<table width='100%' border='0' >";
			string_html_data += "    <tr>";
			string_html_data += "        <td colspan='6'>";
			string_html_data  = "			<table width='100%' border='0' >";
			string_html_data += "        		<tr >";
			string_html_data += "          			<td>";
			string_html_data  = "						<table width='100%' border='0' cellspacing='4' cellpadding='4' >";
			string_html_data += "   						<tr>";
			string_html_data += "        						<td width='15%'><b>#Caso:</b></td><td width='35'><a href='#' onClick='window.open(\"../../../soporte/info_caso/" + o.data.CasoId + "/show\");' />" + o.data.CasoNumero + "</a></td>";
			string_html_data += "        						<td width='15%'><b>Estado:</b></td><td width='35'>" + o.data.Estado + "</td>";
			string_html_data += "    						</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "      							<td colspan='4'>&nbsp;</td>";
			string_html_data += "  							</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "      							<td width='15%'><b>Tarea:</b></td><td colspan='3'>" + o.data.Title + "</td>";
			string_html_data += "  							</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "      							<td colspan='4'>&nbsp;</td>";
			string_html_data += "  							</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "        						<td width='15%'><b>Asignado a:</b></td><td width='35'>" + o.data.NombreAsignado + "</td>";
			string_html_data += "        						<td width='15%'><b>Asignado por:</b></td><td width='35'>" + o.data.NombreAsignadoPor + "</td>";
			string_html_data += "    						</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "      							<td colspan='4'>&nbsp;</td>";
			string_html_data += "  							</tr>";
			string_html_data += "   						<tr>";
			string_html_data += "      							<td width='15%'><b>Fecha de Ejecucion:</b></td><td width='35'>" + o.data.EndDate.toLocaleDateString() + "</td>";
			string_html_data += "      							<td width='15%'><b>Hora de Ejecucion:</b></td><td width='35'>" + o.data.EndDate.toLocaleTimeString() + "</td>";
			string_html_data += "  							</tr>";
			if(o.data.Estado == "Asignada")
			{			
				string_html_data += "   					<tr>";
				string_html_data += "      						<td colspan='4'>&nbsp;</td>";
				string_html_data += "  						</tr>";				
				string_html_data += "   					<tr>";
				string_html_data += "      						<td width='15%'><b>Observacion:</b></td><td colspan='3'><div id='txt_observacion'></div></td>";
				string_html_data += "  						</tr>";				
			}			
			string_html_data += "   						<tr>";
			string_html_data += "      							<td colspan='4'>&nbsp;</td>";
			string_html_data += "  							</tr>";
			string_html_data += "            			</table>";
			string_html_data += "           		</td>";
			string_html_data += "         		</tr>";
			string_html_data += "          	</table>";
			string_html_data += "        </td>";
			...
			DivsData =  Ext.create('Ext.Component', {
				html: string_html_data,
				padding: 1,
				layout: 'anchor',
				style: { border: '0' }
			});
			...
			storeCriterios_aceptar = new Ext.data.JsonStore(
			{
				...
				proxy: {
					type: 'ajax',
					//url : '../info_caso/'+o.data.CasoId+'/getCriterios',
					url : url_getCriterios,
					reader: {
						type: 'json',
						totalProperty: 'total',
						root: 'encontrados'
			...
			storeAfectados_aceptar = new Ext.data.JsonStore(
			{
				...
				proxy: {
					type: 'ajax',
					//url : '../info_caso/'+o.data.CasoId+'/getAfectados',
					url : url_getAfectados,
					reader: {
						type: 'json',
						totalProperty: 'total',
						root: 'encontrados'
			...
			if(o.data.Estado == "Asignada")
			{	
				text_observacion = new Ext.form.TextArea({
					fieldLabel: false,
					id:'calendario_observacion',
					name: 'calendario_observacion',
					rows: 3,
					cols: 120, 
					renderTo: 'txt_observacion'
				});
			}	
		}
		else {
...
viewConfig: {
    ...
    getStoreParams: function() {
        ...
        globalStartDate = params["startDate"]; 
        globalEndDate = params["endDate"]; 
        return params;
    },
