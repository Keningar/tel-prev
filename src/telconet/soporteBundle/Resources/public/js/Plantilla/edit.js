...
Ext.onReady(function(){
    ...
    document.getElementById("telconet_schemabundle_plantillaNotificacionExternatype_nombrePlantilla").value=
	  document.getElementById("plantillaNombre").value;
   
    valorPlantillaCorreo =idClaseDoc == 1?document.getElementById("plantillaValorCorreo").value:'';
    valorPlantillaSms =   idClaseDoc != 1?document.getElementById("plantillaValorSms").value:'';
    ...
    $('#telconet_schemabundle_plantillaNotificacionExternatype_tipo > option[value='+idClaseDoc+']').attr('selected', 'selected');
});
...
function verPlantillaTipo(){
   ...
   if(document.getElementById("telconet_schemabundle_plantillaNotificacionExternatype_tipo").value==1){//1 -> Plantilla Correo : AdmiClaseDocumento
      $('.emailWidgets').show();
      $('.smsWidgets').hide();
      Ext.getCmp("plantillaPanel").setValue("");
   }else{
      $('.smsWidgets').show();
      $('.emailWidgets').hide();
      Ext.getCmp("plantillaPanelsms").setValue("");  
   }
}
