...
var connGenerarReporteArcotel = new Ext.data.Connection({
    listeners: {
        'beforerequest': {
            fn: function(con, opt) {
                Ext.MessageBox.show({
                    msg: 'Generando el archivo Arcotel',
...
function generarReporteArcotel(fechaInicial,fechaFinal)
{

    connGenerarReporteArcotel.request({
        url: urlGenerarReporteArcotel,
        method: 'post',
        params: 
            { 
...
{  
    ...
    if(fechaInicio != "" && fechaFin != "")
    {
        ...
        generarReporteArcotel(fechaInicio,fechaFin);
