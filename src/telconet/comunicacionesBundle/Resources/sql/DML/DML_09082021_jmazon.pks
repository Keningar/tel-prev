/**
 *
 * Se crean plantillas para el producto ECDF
 *	 
...
VALUES
 ( DB_COMUNICACION.SEQ_ADMI_PLANTILLA.NEXTVAL, 'El canal del futbol Restablecer contrasenia', 'ECDF-REST', 'TECNICO',
        ...
        <![endif]-->
                                                    <div style="display:inline-block; max-width:552px; vertical-align:top; width:100%;"
                                                        ...
                                                        <table class="mailpoet_cols-three"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="mailpoet_image "') || TO_CLOB('
                                                                        style="border-collapse:collapse" valign="top"
                                                                        align="center">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mailpoet_paragraph"
                                                                                        ...
                                                                                        satisfactoriamente
                                                                                        tu contrase&ntilde;a de acceso') || TO_CLOB('
                                                                                        para el servicio <strong>El
                                                                                            Canal de
                                                                                            F&uacute;tbol</strong>. A
                                                                                        continuaci&oacute;n se
                                                                                        indicar&aacute; el
                                                                                        usuario y contrase&ntilde;a con
                                                                                        los cuales podr&aacute;s acceder
                                                                                        a la
                                                                                        plataforma <strong>El Canal de
                                                                                            F&uacute;tbol</strong> Si
                                                                                        existen
                                                                                        inconvenientes o novedades con
                                                                                        respecto al servicio no dudes en
                                                                                        contactarnos') || TO_CLOB('
                                                                                        por correo electr&oacute;nico a:
                                            ...
                                            <tr>') || TO_CLOB('
                                                <td class="mailpoet_text mailpoet_padded_vertical mailpoet_padded_side"
                                                    ...
                                                    <h1
                                                        ...
                                                        <strong></strong><strong style="color: #D11E1F;">DATOS DE
                                                            ACCESO<br></strong>
                                                    </h1>
                                                </td>') || TO_CLOB('
                                            </tr>
                                            <tr>
                                                <td class="mailpoet_text mailpoet_padded_vertical mailpoet_padded_side"
                                                    ...
                                                    <h2
                                                        ...
                                                        <strong>Usuario: {{ usuario }}<br>Contraseña') || TO_CLOB('
                                                            : {{ contrasenia }}</strong>
                                                    </h2>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="mailpoet_text mailpoet_padded_vertical mailpoet_padded_side"
                                                    ...
                                                    <h3
                                                        ...
                                                        <strong></strong><strong style="color: #D11E1F;">ACCEDE A TU
                                                            SERVICIO HACIENDO <br></strong>
                                                    </h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="mailpoet_image " style="border-collapse:collapse"
                                                    valign="top" align="center">
                                                    <a href="https://www.netlife.ec/"><img
                                                            src="https://www.netlife.ec/wp-content/uploads/2021/08/btn-futbol.jpg"
                                                            alt="CLICK AQUI"') || TO_CLOB('
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>') || TO_CLOB('
                                                                <td class="mailpoet_paragraph"
                                                                    style="border-collapse:collapse;color:#706f6f;font-family:lato,helvetica neue,helvetica,arial,sans-serif;font-size:16px;line-height:22.4px;word-break:break-word;word-wrap:break-word;text-align:center">
                                                                    <o:p style="font-size: 14.2px">&ldquo;El Servicio
                                                                        contratado El Canal del F&uacute;tbol tiene un
                                                                        costo mensual de Usd. $5.36+IVA, el mismo que
                                                                        ser&aacute; incluido en su factura mensual del
                                                                        Servicio de Internet. &ldquo;&nbsp;</o:p>
                    ...
                    <table style="background-color: #000000;" width="660" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 200px"><a href="https://twitter.com/NetlifeEcuador"><img
                                            ...
                                            alt="internet seguro" width="110" height="30"></a></td>') || TO_CLOB('
...
INSERT INTO DB_COMUNICACION.ADMI_PLANTILLA
(ID_PLANTILLA, NOMBRE_PLANTILLA, CODIGO, MODULO, PLANTILLA, ESTADO, FE_CREACION, USR_CREACION, FE_ULT_MOD, USR_ULT_MOD, EMPRESA_COD)
VALUES(DB_COMUNICACION.SEQ_ADMI_PLANTILLA.NEXTVAL, 'El canal del futbol Nuevo servicio', 'ECDF-NUEVO', 'TECNICO',
TO_CLOB('<html style="margin:0;padding:0" lang="en">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mailpoet_paragraph"
                                                                                        ...
                                                                                        de&nbsp;<strong>El Canal del
                                                                                            F&uacute;tbol&nbsp;</strong>ha
                                                                                        sido activado
                                                                                        satisfactoriamente.<strong>&nbsp;&nbsp;</strong>A
                                                                                        continuaci&oacute;n se
                                                                                        indicar&aacute; el usuario y') || TO_CLOB('
                                                                                        contrase&ntilde;a con los cuales
                                                                                        podr&aacute;s acceder a la
                                                                                        plataforma <strong>El Canal del
                                                                                            F&uacute;tbol</strong> Si
                                                                                        existen inconvenientes o
                                                                                        novedades con respecto al
                                                                                        servicio no dudes en
