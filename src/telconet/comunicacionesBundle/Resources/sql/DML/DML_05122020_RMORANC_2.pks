--INGRESANDO NUEVA PLANTILLA PARA TAREAS DE CABLEADO MD SIN EQUIPOS.
      ...
      <p>SERVICIOS CONTRATADOS</p>
        <table width="100%" border="0" class="box-section-content" style="font-size:11px">
            <tr>
                ...
                <td style="width: 50%" class ="labelGris">{% if servicio.planId.nombrePlan is defined %} {{ servicio.planId.nombrePlan }} {% else %} N/A {% endif %}</td>
                <td style="width: 15%"><b>Tipo Orden:</b></td>
                <td style="width: 30%" class ="labelGris">{% if servicio.tipoOrden is defined %} {{ servicio.tipoOrden }} {% else %} N/A {% endif %}</td>
            </tr>
            <tr>
...
INTO
  ...
  (
    ...
    'Acta de Entrega de Servicio MD para producto Cableado',    
    'ACT-MD-INS-CABL',
    'TECNICO',
    bada,
    'Activo',
