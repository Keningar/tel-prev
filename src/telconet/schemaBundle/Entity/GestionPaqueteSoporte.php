...
/**
 * telconet\schemaBundle\Entity\GestionPaqueteSoporte
 *
 * @ORM\Table(name="ADMI_TAREA")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\GestionPaqueteSoporteRepository")
 */

class GestionPaqueteSoporte
{
/**
* @var AdmiTarea
*
