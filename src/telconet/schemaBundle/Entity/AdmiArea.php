 ...
 *
 * @ORM\Table(name="ADMI_AREA")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\AdmiAreaRepository")
 */
class AdmiArea
{
...
* @ORM\SequenceGenerator(sequenceName="SEQ_ADMI_AREA", allocationSize=1, initialValue=1)
*/		
...
*
* @ORM\Column(name="NOMBRE_AREA", type="string", nullable=false)
*/		
...
*
* @ORM\Column(name="EMAIL_AREA", type="string", nullable=false)
*/		
