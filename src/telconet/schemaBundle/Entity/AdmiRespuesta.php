...
/**
 * telconet\schemaBundle\Entity\AdmiRespuesta
 *
 * @ORM\Table(name="ADMI_RESPUESTA")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\AdmiRespuestaRepository")
 */
class AdmiRespuesta
{
