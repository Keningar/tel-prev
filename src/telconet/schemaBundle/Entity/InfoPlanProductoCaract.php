 ...
 *
 * @ORM\Table(name="INFO_PLAN_PRODUCTO_CARACT")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\InfoPlanProductoCaractRepository")
 */
class InfoPlanProductoCaract
{


/**
* @var integer $planDetId
*
* @ORM\Column(name="PLAN_DET_ID", type="integer", nullable=false)
*/		
...
* @var integer $id
*
* @ORM\Column(name="ID_PLAN_PRODUCTO_CARACT", type="integer", nullable=false)
* @ORM\Id
* @ORM\GeneratedValue(strategy="SEQUENCE")
* @ORM\SequenceGenerator(sequenceName="SEQ_INFO_PLAN_PRODUCTO_CARACT", allocationSize=1, initialValue=1)
*/		
...
* Set planDetId
*
* @param integer $planDetId
*/
public function setPlanDetId($planDetId)
{
