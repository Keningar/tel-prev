...
/**
 * telconet\schemaBundle\Entity\AdmiGrupoPromocionRegla
 *
 * @ORM\Table(name="ADMI_GRUPO_PROMOCION_REGLA")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\AdmiGrupoPromocionReglaRepository")
 */
class AdmiGrupoPromocionRegla
{

/**
* @var integer $id
*
* @ORM\Column(name="ID_GRUPO_PROMOCION_REGLA", type="integer", nullable=false)
* @ORM\Id
* @ORM\GeneratedValue(strategy="SEQUENCE")
* @ORM\SequenceGenerator(sequenceName="SEQ_ADMI_GRUPO_PROMOCION_REGLA", allocationSize=1, initialValue=1)
*/
private $id;
