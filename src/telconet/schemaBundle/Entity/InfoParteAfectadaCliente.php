...
/**
 * telconet\schemaBundle\Entity\InfoParteAfectadaCliente
 *
 * @ORM\Table(name="INFO_PARTE_AFECTADA_CLIENTE")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\InfoParteAfectadaClienteRepository")
 */
class InfoParteAfectadaCliente
{
...
* @var integer $id
*
* @ORM\Column(name="ID_PARTE_AFECTADA_CLIE", type="integer", nullable=false)
* @ORM\Id
* @ORM\GeneratedValue(strategy="SEQUENCE")
* @ORM\SequenceGenerator(sequenceName="SEQ_INFO_PARTE_AFECTADA_CLIENTE", allocationSize=1, initialValue=1)
*/		
