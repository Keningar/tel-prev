...
/**
 * telconet\schemaBundle\Entity\InfoHistoHorarioCuadrilla
 *
 * @ORM\Table(name="INFO_HISTO_HORARIO_CUADRILLA")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\InfoHistoHorarioCuadrillaRepository")
 */
class InfoHistoHorarioCuadrilla
{    
    /**
     * @var integer $id
     *
     * @ORM\Column(name="ID_HISTO_HORARIO_CUADRILLA", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="SEQ_HISTO_HORARIO_CUADRILLA", allocationSize=1, initialValue=1)
     */
    private $id;
