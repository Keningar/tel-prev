...
/**
 * telconet\schemaBundle\Entity\FacturasPeriodo
 *
 * @ORM\Table(name="FACTURAS_PERIODO")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\FacturasPeriodoRepository")
 */
class FacturasPeriodo
{
