 ...
 *
 * @ORM\Table(name="ADMI_PARAMETRO_HIST")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\AdmiParametroHistRepository")
 */
class AdmiParametroHist
{

    /**
     * @var integer $id
     *
     * @ORM\Column(name="ID_PARAMETRO_HIST", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="SEQ_ADMI_PARAMETRO_HIST", allocationSize=1, initialValue=1)
     */
    private $id;
    
    /**
     * @var integer $idParametroDet
     *
     * @ORM\Column(name="ID_PARAMETRO_DET", type="string", nullable=true)
     */
    private $idParametroDet;    

    /**
     * @var integer $parametroId
     *
     * @ORM\Column(name="PARAMETRO_ID", type="integer", nullable=true)
     */
    private $parametroId;
     ...
     * @return integer
     */
    public function getIdParametroDet()
    {
        return $this->idParametroDet;
    }

    /**
     * Set idParametroDet
     *
     * @param integer $idParametroDet
     */
    public function setIdParametroDet($idParametroDet)
    {
     ...
     */
    public function setParametroId($parametroId)
    {
