...
/**
 * telconet\schemaBundle\Entity\InfoDetalleColaborador
 *
 * @ORM\Table(name="INFO_DETALLE_COLABORADOR")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="telconet\schemaBundle\Repository\InfoDetalleColaboradorRepository")
 */
class InfoDetalleColaborador
{
...
* @ORM\SequenceGenerator(sequenceName="SEQ_INFO_DETALLE_COLABORADOR", allocationSize=1, initialValue=1)
*/		
