...
class InfoElementoNodoWifiType extends AbstractType
{
    protected $empresaId;
        ...
        $builder
            ...
            ->add('modeloElementoId','entity',
                    array('class'   =>'telconet\schemaBundle\Entity\AdmiModeloElemento',
                        ...
                        'query_builder' => function ($repository) {
                                                ...
                                                $qr->setParameter("nombreTipoElemento", 'NODO WIFI');
            ...
            ->add('jurisdiccionId','entity',
                    array('class'   =>'telconet\schemaBundle\Entity\AdmiJurisdiccion',
                        ...
                        'mapped'    => false,
                        'attr'      => array('class'=> 'campo-obligatorio',
                                        'onchange'  =>'presentarCantones(this, "telconet_schemabundle_infoelementonodowifitype_cantonId", '
            ...
            ->add('cantonId','choice',
                    array('label'   =>'* Canton:',
                        ...
                        'mapped'    => false,
                        'attr'      => array('class'    => 'campo-obligatorio',
                                            'onchange'  =>'presentarParroquias(this, "telconet_schemabundle_infoelementonodowifitype_parroquiaId",'
    ...
    {
        return 'telconet_schemabundle_infoelementonodowifitype';
    }
}
