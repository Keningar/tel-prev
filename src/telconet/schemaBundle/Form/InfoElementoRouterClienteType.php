...
class InfoElementoRouterClienteType extends AbstractType
{
    /**
     * buildForm
     *
     ...
     * 
     * @author John Vera <javera@telconet.ec>
     * @version 1.1 1-07-2106  se aumento la longitud del campo nombre elemento
     * 
     * @author John Vera <javera@telconet.ec>
     * @version 1.2 12-10-2106  Se aumentó validación de los elementos con el naf
     * 
     */
    ...
    {
        return 'telconet_schemabundle_infoelementorouterclientetype';
    }
}
