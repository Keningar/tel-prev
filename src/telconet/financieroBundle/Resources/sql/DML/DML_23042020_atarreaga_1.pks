/**
 * Se crea dml para plantilla para reportes de documentos diferidos por Emergencia Sanitaria.
 * 
 * @author Alex Arreaga <atarreaga@telconet.ec>
 * @since 1.0 23-04-2020
 */
...
INSERT INTO
  ...
  (
    ...
    'Reporte documentos diferidos por Emergencia Sanitaria',    
    'RPT_DIFERIDOS',
    'FINANCIERO',
    '<html>
<head>
...
<tr><td style="border:1px solid #6699CC;">
    ...
    <tr>
    <td colspan="2">
    En el presente mail se adjunta Reporte de documentos Diferidos por Emergencia Sanitaria. Alguna novedad favor notificar a Sistemas.
    </td></tr>
...
INSERT INTO
  ...
  (
    ...
    (
      SELECT ID_ALIAS
      FROM DB_COMUNICACION.ADMI_ALIAS
      WHERE VALOR      = 'contabilidad@netlife.net.ec'
      AND ESTADO       IN ('Activo','Modificado')
      AND EMPRESA_COD  = '18'    
    ),
    (
