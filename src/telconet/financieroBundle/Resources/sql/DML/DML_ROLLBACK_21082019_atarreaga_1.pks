...
--SE ELIMINA CUENTA AHORRO EN DB_FINANCIERO.ADMI_VALIDACION_FORMATO
DELETE FROM DB_FINANCIERO.ADMI_VALIDACION_FORMATO 
WHERE FORMATO_DEBITO_ID =
  (
...
--SE ELIMINA CUENTA CORRIENTE EN DB_FINANCIERO.ADMI_VALIDACION_FORMATO
DELETE FROM DB_FINANCIERO.ADMI_VALIDACION_FORMATO 
WHERE FORMATO_DEBITO_ID =
  (
...
--ACTUALIZA A 'Activo' EL ADMI_FORMATO_DEBITO_RESPUESTA EXCEL AL BANCO GUAYAQUIL.
...
--ACTUALIZA A ESTADO 'Activo' LOS FORMATOS DE DEBITO DE ENVIO AL BANCO GUAYAQUIL.
...
SET NOMBRE_ARCHIVO_FORMATO = 'COBROSRET',
SEPARADOR_COLUMNA 	  	   = '\t',
FORMATO_NOMBRE					   = 'nombre_archivo|_|Ymd|_|secuencial|_|E0|.|extension',
USR_ULT_MOD                = null,
FE_ULT_MOD                 = null
WHERE BANCO_TIPO_CUENTA_ID = 
	(
