		...
		allowBlank: false,
            ...
            listeners:{
                select:{fn:function(combo, value) {
                    Ext.ComponentQuery.query('combobox[name=idpunto]')[0].reset();
                    Ext.ComponentQuery.query('combobox[name=idpunto]')[0].setDisabled(false);
                    Ext.ComponentQuery.query('combobox[name=idfactura]')[0].setDisabled(true);
                    storePtos.proxy.extraParams = {idcliente: combo.getValue()};
                    storePtos.load();
		...
		listeners: {
            ...
            function renderAcciones(value, p, record) {
                    ...
                    if(record.data.estado=='Pendiente')
                        iconos=iconos+'<b><a href="#" onClick="showCruzar('+record.data.id+','+record.data.total+',\''+record.data.numero+'\')" title="Cruzar Anticipo sin Cliente" class="button-grid-cruzar"></a></b>';                    
