 ...
 * @version 1.0 15-03-2019 | Versión Inicial.
 * @return {boolean}
 *
 */
    ...
    formGetParametrosCab = Ext.create('Ext.form.Panel', {
        ...
        items: [
            ...
            },
            {
                ...
                name: 'strValor2',
                labelStyle: 'font-weight:bold;',
                value: 'MOTIVOS DE RECHAZO DE ORDEN DE SERVICIO MEDIANTE PYL',
                textAlign: 'left'
            }
        ],
        ...
        buttons: [{
            ...
            handler: function() {              
              ...
              Ext.MessageBox.confirm(
                  'Activar Par\u00e1metro Motivos de Rechazo PYL ',
                  '¿Est\u00e1 seguro de activar el par\u00e1metro Motivos de Rechazo PYL ?',
                  function(btn) {
                      if (btn === 'yes') {

                          Ext.MessageBox.show({
                              msg: 'Activando Motivos de Rechazo PYL ...',
                              title: 'Activando',
                              progressText: 'Activando Motivos de Rechazo PYL ...',
                              progress: true,
                              closable: false,
                              width: 300,
                              wait: true,
            ...
            handler: function() {              
              ...
              Ext.MessageBox.confirm(
                  'Inactivar Par\u00e1metro',
                  '¿Est\u00e1 seguro de inactivar el par\u00e1metro Motivos de Rechazo PYL?',
                  function(btn) {
                      if (btn === 'yes') {
                          Ext.MessageBox.show({
                              msg: 'Inactivando Motivos de Rechazo PYL ...',
                              title: 'Inactivando',
                              progressText: 'Inactivando Motivos de Rechazo PYL ...',
                              progress: true,
                              closable: false,
                              width: 300,
                              wait: true,
