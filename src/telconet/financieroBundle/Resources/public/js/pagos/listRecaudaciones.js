		...
		listeners: {
                ...
                Ext.define('ListaDetalleModel', {
                    ...
                    fields: [{name:'id', type: 'int'},
                            ...
                            {name:'canalRecaudacion', type: 'string'},
                            {name:'linkVer', type: 'string'},
                            {name:'linkExcelRec', type: 'string'},
                            {name:'linkFormatoRec', type: 'string'}
                            ]
                }); 
                ...
                var listView = Ext.create('Ext.grid.Panel', {
                    ...
                    {
                        text: 'Canal Recaudacion',
                        dataIndex: 'canalRecaudacion',
                        align: 'left',
                        flex: 100
                    },                        
					{
            ...
            function renderAcciones(value, p, record) {
                    var iconos='';
                    iconos=iconos+'<b><a href="'+record.data.linkVer+'" onClick="" title="Ver Pagos Registrados" class="button-grid-show"></a></b>';
			if(record.data.linkExcelRec)	
		      		iconos=iconos+'<b><a href="'+record.data.linkExcelRec+'" onClick="" title="Descargar Reporte Archivo Recaudacion" class="button-grid-excel"></a></b>';
                if(boolDescargarFormatoRecaudacion)
                {
                    iconos=iconos+'<b><a href="'+record.data.linkFormatoRec+
                                  '" onClick="" title="Descargar Formato Envio Recaudacion" class="button-grid-zip"></a></b>';
                }
