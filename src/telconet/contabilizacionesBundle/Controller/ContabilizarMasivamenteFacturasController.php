...
use telconet\contabilizacionesBundle\Controller\DefaultController;

class ContabilizarMasivamenteFacturasController extends Controller
{
    public function indexAction()
    {
		...
		echo "\n";
		echo "=============================================\n";
		echo "Contabilizacion Masiva de Facturas\n";
		echo "=============================================\n";
		...
		$resultado=$emfn->getRepository('schemaBundle:InfoDocumentoFinancieroCab')->obtenerFacturasParaMigra();
        ...
        foreach($listadoFacturas as $factura)
        {
				...
				//echo "<br />";
				echo "\n";
				$facturasController=new DefaultController();
