...
class DefaultController extends Controller
{
			...
			try
			{
				...
				else
				{
					...
					foreach($listado_det as $detalle)
					{
						...
						$valores_dos['pv_concepto']=$glosa;
						$valores_dos['pn_monto']=$detalle['precioVentaFacproDetalle']*(-1);
						$valores_dos['pv_tipodiario']="M_F_1";
					...
					$valores_dos['pv_concepto']=$glosa;
					$valores_dos['pn_monto']=$info_imp['totalImpuesto']*(-1);
					$valores_dos['pv_tipodiario']="M_F_1";
					$valores_dos['pv_tipo']="C";
	...
	public function buscarExistentente($id_factura,$empresa_id)
	{
		$variable_existe['migra_arcgae']=0;
		$em_naf = $this->getDoctrine()->getManager("telconet_naf");
		$resultado_dos = $em_naf->getRepository('schemaBundle:MigraArcgae')->getExisteFacturaContabilidad($id_factura,$empresa_id);
