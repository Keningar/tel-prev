...
use telconet\contabilizacionesBundle\Controller\NotaCreditoAnulacionController;

class ContabilizarMasivamenteAnulacionNCController extends Controller
{
    public function indexAction()
    {
		...
		echo "\n";
		echo "=============================================\n";
		echo "Contabilizacion Anulaciones Masivas de NC\n";
		echo "=============================================\n";
		...
		$resultado=$emfn->getRepository('schemaBundle:InfoDocumentoFinancieroCab')->obtenerNCAnuladasParaMigra();
        ...
        foreach($listadoNC as $nota)
        {
				...
				//echo "<br />";
				echo "\n";
				$nc=new NotaCreditoAnulacionController();
