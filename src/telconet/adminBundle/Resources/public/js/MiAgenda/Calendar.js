...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    show: function(o, animateTarget){
        ...
        if (o.data) {            
            ...
            var origen = o.data.Origen;
            var tarea = o.data.Title;          
            var observacion = o.data.Observacion;   
             var feAsignada = o.data.FeAsignada;
             var nombreAsignadoPor=o.data.NombreAsignadoPor;
             var nombreAsignado=o.data.NombreAsignado;
						...
						items: [
							...
							},
							{
								...
								readOnly: true
                                                        ...
                                                        {
								xtype: 'displayfield',
								fieldLabel: 'Asignado Por',
								id: 'asignadoPor',
								name: 'asignadoPor',
								value: nombreAsignadoPor,
								readOnly: true
							},
                                                        {
								xtype: 'displayfield',
                                                        ...
                                                        
							{
								...
								id: 'calendario_fechaEjecucion',
								name: 'calendario_fechaEjecucion',
							...
							},
							{
								...
								id: 'calendario_horaEjecucion',
								name: 'calendario_horaEjecucion',
								...
								value: feAsignada.toLocaleDateString(),
								readOnly: true
							},
                                                        {
								xtype: 'displayfield',
								...
								value: feAsignada.toLocaleTimeString(),
								readOnly: true
							},
							{
								xtype: 'textareafield',
