 ...
 *
 * @author Richard Cabrera <rcabrera@telconet.ec>
 * @version 1.1 10/09/2020 - Se consideran todas las ips que tiene asociado un servicio, se renombra el campo ESTADO por ESTADO_SERVICIO y se adiciona el campo ESTADO_IP
 *
 * @author Richard Cabrera <rcabrera@telconet.ec>
 * @version 1.2 07/10/2020 - Validar que el estado de las caracteristicas del servicio: CAPACIDAD1 Y CAPACIDAD2 esten en estado Activo.
 *
 */
