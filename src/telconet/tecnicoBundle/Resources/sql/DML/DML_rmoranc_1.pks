--Actualizando Plantillas acta de instalación TN
...
DBMS_LOB.APPEND(bada, '<html>
   ...
   <body class="c64">
	  ...
	  <div style="margin-top: 20px;">
         <hr>
		 <p class="c6"><span>Esta acta es evidencia de la entrega del medio físico para el servicio contratado.</span></p>
      </div>
