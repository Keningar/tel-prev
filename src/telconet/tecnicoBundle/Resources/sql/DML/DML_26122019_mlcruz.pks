...
BEGIN
  ...
  INTO DB_GENERAL.ADMI_PARAMETRO_CAB
    ...
    (
      ...
      'DIRECTORIO_CPM_MD',
      'Directorio de Telcos donde se guardarán los archivos subidos para el cambio de plan masivo',
      'Activo',
      'mlcruz',
      CURRENT_TIMESTAMP,
      '127.0.0.1'
  ...
  SELECT ID_PARAMETRO
  INTO Ln_IdParamDirCpm
  FROM DB_GENERAL.ADMI_PARAMETRO_CAB
  WHERE NOMBRE_PARAMETRO='DIRECTORIO_CPM_MD'
  AND ESTADO            = 'Activo';
  INSERT
  ...
  SYS.DBMS_OUTPUT.PUT_LINE('Se creó correctamente el directorio para los archivos csv subidos en Telcos para el cambio de plan masivo');
  COMMIT;
EXCEPTION
WHEN OTHERS THEN
...
<body>
                ...
                <table width="100%" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2">El presente correo es para indicarle que se procedió a subir al telcos un archivo 
                            con {{NUM_REGISTROS_TOTAL}} registros de clientes que se cambiarán de plan.
  ...
  INTO DB_COMUNICACION.INFO_ALIAS_PLANTILLA
    ...
    (
      DB_COMUNICACION.SEQ_INFO_ALIAS_PLANTILLA.NEXTVAL,
      364,--sistemas-devops@telconet.ec
      Ln_IdPlantilla,
      'Activo',
      SYSDATE,
      'mlcruz',
  ...
  SYS.DBMS_OUTPUT.PUT_LINE('Se creó la plantilla correctamente CPMSUBIDA');
  COMMIT;
EXCEPTION
WHEN OTHERS THEN
  SYS.DBMS_OUTPUT.PUT_LINE('Error: '|| SQLCODE || ' - ERROR_STACK: ' || DBMS_UTILITY.FORMAT_ERROR_STACK || ' - ERROR_BACKTRACE: ' 
