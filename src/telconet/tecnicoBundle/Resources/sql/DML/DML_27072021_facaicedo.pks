...
DECLARE
    ...
    type                typeArrayNodosMulti IS VARRAY(190) OF VARCHAR2(45);
    ...
    Lr_NodosMulti       typeArrayNodosMulti;
    --
...
BEGIN
    ...
    FOR i in 1 .. Ln_Total LOOP
        --elemento
        SELECT DB_INFRAESTRUCTURA.SEQ_INFO_ELEMENTO.NEXTVAL INTO Ln_IdElemento FROM DUAL;
        INSERT INTO DB_INFRAESTRUCTURA.INFO_ELEMENTO
        VALUES (
            Ln_IdElemento,
            1985,
            TRIM(INITCAP(Lr_Agregadores(i))),
            'DISPOSITIVO AGREGADOR',
        ...
        (DB_INFRAESTRUCTURA.SEQ_INFO_EMPRESA_ELEMENTO.NEXTVAL,Ln_IdEmpresa,Ln_IdElemento,'AGREGADOR MULTIPLATAFORMA','Activo',Lb_User,
        sysdate,'127.0.0.1');
        --historial elemento
        INSERT INTO DB_INFRAESTRUCTURA.INFO_HISTORIAL_ELEMENTO VALUES
        (DB_INFRAESTRUCTURA.SEQ_INFO_HISTORIAL_ELEMENTO.NEXTVAL,Ln_IdElemento,'Activo',null,'Registro creado por gestión Olt Multiplataforma',
        Lb_User,sysdate,'127.0.0.1');
        --contador
    ...
    FOR i in 1 .. Ln_Total LOOP
        ...
        IF Ln_IdElemento IS NOT NULL and Ln_IdElementoAgre IS NOT NULL THEN
            --insert el detalle elemento del agregador al nodo
        ...
        ELSE
            dbms_output.put_line('NODO: ' || Lr_Nodos(i) || ' AGREGADOR: ' || TRIM(INITCAP(Lr_NodosRelacion(i))));
        END IF;
    END LOOP;
    --
    --insertar detalle multiplataforma
    --
    Lr_NodosMulti := typeArrayNodosMulti('Guasmo Sur 1 (E)','Mucho Lote (E)','Trinitaria 1 (E) Migrando ','Trinitaria 2 (E)','Estero Salado 2 (E)',
                                'Union de Bananeros (E)','Esteros 1 (E)','Batallon 3 (E)','Orquideas gye (E)','Prosperina 1  Gepon (E)','Bastion 2 (E)',
                                'Juan Montalvo (E)','Guasmo Este (E)','Estero Salado 1 (E)','CAE (E)','Gomez Rendon  (E)','Esclusas (E)',
                                'Vergeles 1 (E)','Floresta 1 (E)','Puerto Liza (E)','Mapasingue 5 (E)','Jardines de la Esperanza (E)','Pradera 1 (E)',
                                'La 29 y Bolivia (E)','Sur gye (A)','Vachagnon 1 (E)','Guayacanes (E)','Avenida 14 y Venezuela (E)','Florida 2 (E)',
                                'Inmaconsa (A)','Divino Niño (E)','Vergeles 2 (E)','Beatriz Bejar (E)','Miraflores (A) MIGRANDO ','Letamendi (E)',
                                'Sauces 6 (E)','Orellana gye (E)','27 diagonal y Transversal (E)','Bastion 1 (E)','Ciudad del Rio (E)',
                                'Luz del Guayas 1 (E)','Puertas del Sol (E) ','Mapasingue 4 (E)','Hospital Guayaquil (E)','Sauces 2 (E)',
                                'Americas 2 (E)','Girasoles (E)','Brahma (E)','Urbanor (E)','Kennedy 2 (E)','Bellavista Gepon (E)','Americas 1 (E)',
                                'Nueva Prosperina 1 (E)','Kennedy 1 (A)','Samanes 6 (E) Migrando ','La Saiba (E)','Chongon (E)','Batallon 1 (E)',
                                'Vacas Galindo (E)','Martha de Roldos (E)','Portete de Tarqui (E)','Emtelsur (E)','Agregador Centro (A)',
                                'Florida 1 (E)','Pycca (E)','Urdesa 2 (E)','Luz del Guayas 2 (E)','Ceibos (E)','Montebello (E)','Nueva Esperanza (E)',
                                'km 18 (E)','Beata Molina 1 (E)','Colegio Jose Llerena (E)','Paraiso de la flor 2  (E)','Paraiso de la flor 1 (E)',
                                'Mi lote (E)','Pascuales 1 (E)','Nueva Prosperina (E)','Pascuales 2 (E)','Alcedo y Agusto Dillon (E)','Sauces 4 (E)',
                                'Alcedo y Aciclo Garay (E)','Puerto Hondo (E)','Atarazana (E)','Monte Sinai (E)','Sergio Toral (E)',
                                'Calle B (E)','Zaragoza (E)','Calderon (E)','Sur 2 (A)','Solis (E)','Cardenas (E)','Condor (E)','Cipreses (E)',
                                'Roldos (E)','Montalvo (E)','Tabiazo (E)','Kennedy (E)','Mitad del Mundo (E)','Isla Española (E)','Villalengua (E)',
                                'Bodega (E)','Pomasqui (E)','Gaspar (E)','Carapungo (E)','Guachan (E)','Guabos (E)','Lucha de los pobres (E)',
                                'Gosseal (A)','Acevedo (E)','Ejido (E)','Alondras (E)','Quitumbe (E)','Whymper (E)','Muller (E)','Chillogallo (E)',
                                'San Bartolo (E)','Lumbisi (E)','Muros (A)','El Sol (E)','Morlan (E)','Chura (E)','Orquideas (E)','S50 (E)',
                                'Chiriyacu (E)','Tumbaco (E)','Principe (E)','Fortines (E)','Ajavi (E)','Guamani (E)','Calle H (E)','Tarqui 11 (E)',
                                'Calle 11 (E)','Colinas (E)','Belmonte / Metropoli (E)','Cocotog (E)','Ferrero (E)','Swiss hotel  (E)','Colon (E)',
                                'Recreo (E)','Solanda (E)','Inglaterra (E)','Illinworth (E)','Labrador (E)','Real Audiencia (E)','Gualleturo (E)',
                                'Vasquez (E)','Cotocollao (E)','Calle A (E)','Eucaliptos (E)','Nazacota (E)','Murialdo (E)','Borromoni (A)',
                                '18 de Septiembre (E)','Complejo Quito (E)','Nogales (E)','Ponce (E)','Quiroz (E)','Molina (E)','Iturralde (E)',
                                'Córdova (E)','Baquedano (E)','San Carlos (E)','Pampa (E)','Chaupitena (E)','Troje (E)','Calle D (E)',
                                'Plaza de Toros (E)','Armenia (A)','Florida (E)','Calle 3 (E)','Benitez (E)','Mandarina (E)','Parque Industrial (E)',
                                'Morales (E)','San Juan de Calderon (E)','Cochapamba (E)','Ruiz (E)','Rivera (E)','Calle K (E)','Zabala (E)',
                                'Recoleta (E)','Salazar (E)','San Juan de Conocoto (E)','Tanda (E)','Canada (E)','Barrio Ecuador (E)','Orellana (E)',
                                'Dos Puentes (E)','Guayasamin (E)');
    --
    Ln_Total := Lr_NodosMulti.count;
    --
    FOR i in 1 .. Ln_Total LOOP
        --
        Ln_IdElemento := NULL;
        --obtengo el id del nodo
        OPEN C_getIdElemento(Lr_NodosMulti(i),350);
        FETCH C_getIdElemento INTO Ln_IdElemento;
        CLOSE C_getIdElemento;
        --
        IF Ln_IdElemento IS NOT NULL THEN
            ...
            --
            IF Ln_IdDetElemento IS NULL THEN
    ...
    dbms_output.put_line('');
    dbms_output.put_line('');
    dbms_output.put_line('INSERT AGREGADORES: ' || Ln_ContadorAgre);
    dbms_output.put_line('INSERT RELACIONES AGREGADORES: ' || Ln_ContadorRel);
    dbms_output.put_line('INSERT PERMITIDO MULTIPLATAFORMA: ' || Ln_ContadorPerm);

    --update detalle agregador
    UPDATE DB_GENERAL.ADMI_PARAMETRO_DET PDE SET PDE.VALOR7 = 'AGREGADOR_ASIGNADO' WHERE PDE.ID_PARAMETRO_DET = (
