Ext.onReady(function() {
    ...
    combo_nodos = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoroutertype_nodoElementoId').val(combo.getValue());
                    $('#telconet_schemabundle_infoelementoroutertype_rackElementoId').val('');
                    $('#telconet_schemabundle_infoelementoroutertype_unidadRack').val('');
    ...
    combo_rack = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoroutertype_rackElementoId').val(combo.getValue());
                    $('#telconet_schemabundle_infoelementoroutertype_unidadRack').val('');
                    Ext.getCmp('combo_unidades').reset();
    ...
    combo_unidades = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoroutertype_unidadRack').val(combo.getValue());
                }}
        }
    });
...
function validacionesForm() {
    //validar nombre caja
    if (document.getElementById("telconet_schemabundle_infoelementoroutertype_nombreElemento").value == "") 
    {
    ...
    //validar ip
    if (document.getElementById("telconet_schemabundle_infoelementoroutertype_ipElemento").value == "") 
    {
        alert("Falta llenar algunos campos");
        return false;
    }
    ...
    //validar modelo
    if (document.getElementById("telconet_schemabundle_infoelementoroutertype_modeloElementoId").value == "") 
    {
        alert("Falta llenar algunos campos");
        return false;
    }
    ...
    //validar nodo
    if (document.getElementById("telconet_schemabundle_infoelementoroutertype_nodoElementoId").value == "" || 
    ...
    {
        if (document.getElementById("telconet_schemabundle_infoelementoroutertype_rackElementoId").value != "") 
        {
            ...
            {
                if (document.getElementById("telconet_schemabundle_infoelementoroutertype_unidadRack").value == "" || 
