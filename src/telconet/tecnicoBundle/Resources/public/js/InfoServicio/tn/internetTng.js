...
var strVariable="Seleccione una Conexion";
        ...
        success: function (response)
        {
            ...
            Ext.getCmp('observacionAnterior').setValue(json['encontrados'][cont].observacion);
        }
    });
    ...
    var confirmarFormPanel = Ext.create('Ext.form.Panel', {
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                     ...
                                     readOnly: false,
                                     regex: /^(\d+)$/,
                                     regexText: "Lo ingresado no tiene un correcto formato.", 
                                     required : true,
                                     listeners: {
                                        blur: function (plazo)
                                        {
                ...
                buttons: [{
                    ...
                    handler: function(){
                        ...
                        {
                            var activar = false;
                            Ext.MessageBox.confirm('Confirmacion ', 'Desea activar el servicio?', function (btn) {
                                if (btn == 'yes') {
                                    strControl = "Activar";
                                    activar = true;
                                } else {
