 ...
 * un servicio Seg Vehiculo para la empresa TN
 * 
 ...
 * @param       gridIndex
 * */
function confirmarServicioSegVehiculo(data, gridIndex)
{
    Ext.get(gridServicios.getId()).mask('Consultando Datos...');
    Ext.Ajax.request({
        url: getElementosSegVehiculo,
        method: 'post',
        timeout: 400000,
        params: {
                            ...
                            [
                                {
                                    ...
                                    items: [
                                        ...
                                        { width: '10%', border: false},
                                        {
                                            ...
                                            displayField: data.tipoTransporte,
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            html : '<div id="agregar-dispositivo-'+arrayElementos[tipoKeyElemento][contEle].key+
                                                    ...
                                                    'onclick="addDispositivosSegVehiculo(\''+arrayElementos[tipoKeyElemento][contEle].key+'\',0)"'+
                                                    '></i></label></div>'
                                        },
                                    ]
                                },
...
function addDispositivosSegVehiculo(name, accion){
