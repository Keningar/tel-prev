 ...
 * un servicio internet dedicado para la empresa TN
 *
 ...
 * @version     1.3     04-09-2019       Se agrega productos a la activacion de DataCenter.
 * 
 * @param Array data        Informacion que fue cargada en el grid
 * @param       gridIndex
 * */
function activarServicioInternet(data, gridIndex)
{
    ...
    var seActiva = true;
    var esInternetDC = false;
    var storeTipoElementosActivos = [];

    if(data.descripcionProducto === 'INTERNETDC' || data.descripcionProducto === 'DATOSDC' ||
       data.descripcionProducto === 'INTERNET DC SDWAN' || data.descripcionProducto === 'DATOS DC SDWAN')
    {
        esInternetDC = true;

        storeTipoElementosActivos = new Ext.data.Store({
            fields: ['valor1','valor2'],
            data: data.arrayElementosActivos
        });
    }
                        ...
                        var formPanel = Ext.create('Ext.form.Panel', {
                                    ...
                                    [
                                       {
                                            ...
                                            items: [
                                                ...
                                                { width: '10%', border: false},
                                                {
                                                    xtype: 'textfield',
                                                    name: 'firewallDC',
                                                    fieldLabel: 'Firewall (DC)',
                                                    displayField: data.firewallDC,
                                                    value: data.firewallDC,
                                                    readOnly: true,
                                                    disabled:!esInternetDC,
                                                    width: '30%'
                                                },
                                                ...
                                                { width: '10%', border: false},
                                                {
                                                    xtype: 'textfield',
                                                    name: 'vlanLan',
                                                    fieldLabel: 'Vlan Lan (DC)',
                                                    displayField: data.vlanLan,
                                                    value: data.vlanLan,
                                                    readOnly: true,
                                                    disabled:!esInternetDC,
                                                    width: '30%'
                                                ...
                                                { width: '15%', border: false},
                                                {
                                                    xtype: 'textfield',
                                                    name: 'vlanWan',
                                                    fieldLabel: 'Vlan Wan (DC)',
                                                    displayField: data.vlanWan,
                                                    value: data.vlanWan,
                                                    readOnly: true,
                                                    disabled:!esInternetDC,
                                                    width: '30%'
                                                    ...
                                                    listeners:
                                                    {
                                                        change: function (cb, nv, ov)
                                                        {
                                                            if (nv)
                                                            {
                                                                ...
                                                                if(data.strPropietarioCpeCliente != "")
                                                                {
                                                                ...
                                                                if(data.strSerieTransceiverCliente != "")
                                                                {
                                            ...
                                            [
                                                {
                                                    ...
                                                    items: [
                                                            ...
                                                            listeners:
                                                            {
                                                                select: function(combo)
                                                                {
                                                                    ...
                                                                    if (propiedad === 'CLIENTE')
                                                                    {
                                                                        ...
                                                                        {
                                                                            Ext.getCmp('descripcionNuevoCpe').setReadOnly(true);
                                                                            Ext.getCmp('serieNuevoCpe').setDisabled(true);
                                                                            Ext.getCmp('modeloNuevoCpe').setDisabled(true);
                                                                            Ext.getCmp('macNuevoCpe').setReadOnly(false);

                                                                            Ext.getCmp('versionIosNuevoCpe').setDisabled(true);
                                                                            Ext.getCmp('gestionRemotaNuevoCpe').setDisabled(true);
                                                                            Ext.getCmp('administraNuevoCpe').setDisabled(true);
                                                                            Ext.getCmp('cmbTipoEquipoActivo').setDisabled(false);
                                                                            Ext.getCmp('interfaceVirtual').setDisabled(false);
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                        ...
                                                                        {
                                                                            Ext.getCmp('descripcionNuevoCpe').setReadOnly(false);
                                                                            Ext.getCmp('serieNuevoCpe').setDisabled(false);
                                                                            Ext.getCmp('modeloNuevoCpe').setDisabled(false);
                                                                            Ext.getCmp('macNuevoCpe').setReadOnly(false);

                                                                            Ext.getCmp('versionIosNuevoCpe').setDisabled(false);
                                                                            Ext.getCmp('gestionRemotaNuevoCpe').setDisabled(false);
                                                                            Ext.getCmp('administraNuevoCpe').setDisabled(false);
                                                                            Ext.getCmp('cmbTipoEquipoActivo').setDisabled(true);
                                                                            Ext.getCmp('interfaceVirtual').setDisabled(true);
                                                                        }
                                                                    }
                                                                }
                                                            }
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            id:             'nombreNuevoCpe',
                                                            name:           'nombreNuevoCpe',
                                                            fieldLabel:     !esInternetDC?'Nombre Cpe':'Nombre Equipo',
                                                            displayField:   '',
                                                            value:          '',
                                                            labelWidth:      110,
                                                            width:          '70%'
                                                        ...
                                                        {
                                                            xtype:          'combobox',
                                                            fieldLabel:     '<b>* Tipo Equipo Activo</b>',
                                                            id:             'cmbTipoEquipoActivo',
                                                            value:          'Seleccione',
                                                            editable:        false,
                                                            hidden:         !esInternetDC,
                                                            store:           storeTipoElementosActivos,
                                                            displayField:   'valor1',
                                                            valueField:     'valor2',
                                                            labelWidth:      110,
                                                            width:          '60%'
                                                        ...
                                                        {width:'20%',border:false},
                                                        {
                                                            ...
                                                            hidden:         !esInternetDC,
                                                            emptyText:      '0',
                                                            fieldLabel:     '<b>Puerto Remoto (Eth)</b>',
                                                            displayField:   '',
                                                            value:          '',
                                                            labelWidth:      110,
                                                            width:          '60%'
                            ...
                            [{
                                ...
                                handler : function()
                                {
                                    ...
                                    //datos tipo equipos activo de red para INT DC
                                    var siglaEquipoActivo           = Ext.getCmp('cmbTipoEquipoActivo').getValue();
                                    var tipoEquipoActivo            = Ext.getCmp('cmbTipoEquipoActivo').getRawValue();
                                    var interfaceVirtual            = Ext.getCmp('interfaceVirtual').getValue();
                                    ...
                                    if (flagCpe === "nuevo" && flag == 0)
                                    {
                                        ...
                                        else if(esInternetDC)
                                        {
                                            if(!Ext.isEmpty(propiedadNuevoCpe))
                                            {
                                                if(propiedadNuevoCpe === 'CLIENTE')
                                                {
                                                    if(Ext.isEmpty(tipoEquipoActivo) || tipoEquipoActivo === 'Seleccione' ||
                                                       Ext.isEmpty(interfaceVirtual) || Ext.isEmpty(macNuevoCpe) ||
                                                       Ext.isEmpty(nombreNuevoCpe))
                                                     {
                                                         validacion = false;
                                                     }
                                                     else
                                                ...
                                                else
                                                {
                                                    if( serieNuevoCpe === ""  ||
                                                        macNuevoCpe   === ""  ||
                                                        (iosNuevoCpe  === "-Seleccione-" || Ext.isEmpty(iosNuevoCpe)) ||
                                                        gestionNuevoCpe === "-Seleccione-" ||
                                                        administraNuevoCpe === "-Seleccione-"
                                                      )
                                                    {
                                        ...
                                        Ext.Ajax.request({
                                            ...
                                            params: {
                                               ...
                                               'idTecnicoEncargado'    : idTecnicoEncargado,
                                                ...
                                                descripcionNuevoCpe:    descripcionNuevoCpe,
                                                ...
                                                //INTERNET DC y DATOS DC
                                                vlanLan      : data.vlanLan,
                                                vlanWan      : data.vlanWan,
                                                firewall     : data.firewallDC,
                                                elementoPadre: datos[0].nombreElementoPadre,
                                                tipoEquipo   : tipoEquipoActivo,
                                                siglaEquipo  : siglaEquipoActivo,
                                                puertoRemoto : interfaceVirtual,
...
function limpiarCamposInternetDedicado()
{
...
function CargarInformacionCPE(data, modelo){
    ...
    Ext.getCmp('cmbInterfaceElemento').setRawValue(objeto.nombreElemento);
