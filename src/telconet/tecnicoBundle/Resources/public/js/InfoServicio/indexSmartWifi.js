/**
 * confirmarServicioSmartWifi
 * 
 * Funcion que sirve para confirmar los servicios Smart Wifi de MD
 * 
 ...
 * @param idAccion
 */
function confirmarServicioSmartWifi(data, idAccion)
{
    ...
    var confirmarFormPanel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            ...
            {
                xtype: 'fieldset',
                title: 'Información del Equipo Smart Wifi',
                defaultType: 'textfield',
                defaults: {
                    width: 600
                },
        ...
        buttons: [{
                ...
                handler: function() {
                    ...
                    if (booleanValidacion) 
                    {
                        ...
                        Ext.Ajax.request({
                            url: confirmarServicioSmartWifiBoton,
                            method: 'post',
                            timeout: 400000,
                            params: {
                                ...
                                idAccion                        : idAccion,
                                strSerieSmartWifi               : strSerieWifi,
                                strModeloSmartWifi              : strModeloWifi,
                                strMacSmartWifi                 : strMacWifi,
    ...
    var win = Ext.create('Ext.window.Window', {
        title: 'Confirmar Servicio Smart Wifi',
        modal: true,
        width: 650,
        closable: true,
        layout: 'fit',
...
/**
 * cancelarServicioSmartWifi
 * 
 * Funcion que sirve para cancelar los servicios Smart Wifi de MD
 * 
 * @author Jesus Bozada <jbozada@telconet.ec>
 * @version 1.0 23-02-2017
 * @param data
...
/**
 * cortarServicioSmartWifi
 * 
 * Funcion que sirve para cortar los servicios Smart Wifi de MD
 * 
 * @author Jesus Bozada <jbozada@telconet.ec>
 * @version 1.0 23-02-2017
 * @param data
...
/**
 * reconectarServicioSmartWifi
 * 
 * Funcion que sirve para reconectar los servicios Smart Wifi de MD
 * 
 * @author Jesus Bozada <jbozada@telconet.ec>
 * @version 1.0 23-02-2017
 * @param data
 * @param idAccion
 */
function reconectarServicioSmartWifi(data,idAccion)
{
    Ext.Msg.alert('Mensaje','Esta seguro que desea Reconectar el Servicio?', function(btn){
        if(btn=='ok'){
            ...
            Ext.Ajax.request({
                url: reconectarServicioSmartWifiBoton,
                method: 'post',
                timeout: 400000,
                params: { 
                    idServicio: data.idServicio,
...
/**
 * Funcion que sirve para agregar elemento en los servicios Smart Wifi de MD
 * 
 * @author Jesus Bozada <jbozada@telconet.ec>
 * @version 1.0 23-02-2017
 * @param data
 * @param idAccion
 */
function agregarElementoSmartWifi(data, idAccion)
{
    Ext.define('ListaParametrosDetModel', {
        extend: 'Ext.data.Model',
        fields: [{name: 'intIdParametroDet', type: 'int'},
        ...
        buttons: [{
                ...
                handler: function() {
                    ...
                    if (booleanValidacion) 
                    {
                        ...
                        Ext.Ajax.request({
                            url: agregarEquipoSmartWifiBoton,
                            method: 'post',
                            timeout: 400000,
                            params: {
                                idServicio                      : data.idServicio,
                            ...
                            success: function(response) {
                                ...
                                if (strStatus == "OK") {
                                    win.destroy();
                                    Ext.Msg.alert('Mensaje', 'Se agregó el equipo Smart Wifi al Servicio: ' + data.login, function(btn) {
                                        if (btn == 'ok') {
                                            store.load();
                                        }
                                    });
    ...
    var win = Ext.create('Ext.window.Window', {
        title: 'Agregar Equipo Smart Wifi',
        modal: true,
        width: 650,
        closable: true,
        layout: 'fit',
