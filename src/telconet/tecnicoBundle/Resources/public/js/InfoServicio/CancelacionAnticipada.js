...
function cancelarServicioMdFacturacion(arrayParametros){
    ...
    Ext.Ajax.request({
        ...
        success: function(response){
            ...
            if (data.descripcionProducto == 'INTERNET SMALL BUSINESS')
            {
                strName         = 'producto';
        ...
        //                                id:'perfilDslam',
            ...
            buttons: [{
                ...
                handler: function(){
                    ...
                    if(validacion)
                    {
                          Ext.Msg.confirm('Mensaje','Esta seguro que desea Cancelar el cliente?', function(btn){
                          if(btn=='yes')
                          {
                                ...
                                {                                     
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        failure: function(result)
                                        {
                                            ...
                                            Ext.get(formPanel.getId()).unmask();
                                            Ext.getCmp("btnEjecutar").setDisabled(false);
                                            Ext.Msg.alert('Error ','Error: ' + result.statusText, Ext.emptyFn);
                                        }
                                    }); 
                                }else{
                                    Ext.get(gridServicios.getId()).mask('Esperando Respuesta del Elemento...');
