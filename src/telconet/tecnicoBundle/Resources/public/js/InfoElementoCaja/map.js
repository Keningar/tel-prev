...
function validacionesForm(){
    //validar nombre caja
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_nombreElemento").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_descripcionElemento").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_alturaSnm").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_nivel").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_direccionUbicacion").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_ubicadoEn").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementocajatype_modeloElementoId").value==""){
        alert("Falta llenar algunos campos");
        return false;
    }
    ...
    if(!validarCoordenadasPorPaisForm(document.forms[0], "telconet_schemabundle_infoelementocajatype"))
        return false;
...
function dd2dms(lat,lng) {            
  ...
  lng = lng.toString();
    ...
    $("#telconet_schemabundle_infoelementocajatype_latitudUbicacion").val(lat);
    $("#telconet_schemabundle_infoelementocajatype_longitudUbicacion").val(lng);
...
//    Ext.getCmp('telconet_schemabundle_infoelementodslamtype_latitudUbicacion').value = valor_latitud;
//    Ext.getCmp('telconet_schemabundle_infoelementodslamtype_longitudUbicacion').value = valor_longitud;
             
    $("#telconet_schemabundle_infoelementocajatype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementocajatype_longitudUbicacion").val(valor_longitud);
