...
Ext.onReady(function() {
    ...
    combo_nodos = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoodftype_nodoElementoId').val(combo.getValue());
    ...
    combo_rack = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoodftype_rackElementoId').val(combo.getValue());
                    $('#telconet_schemabundle_infoelementoodftype_unidadRack').val('');
                    Ext.getCmp('combo_unidades').reset();
    ...
    combo_unidades = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    $('#telconet_schemabundle_infoelementoodftype_unidadRack').val(combo.getValue());
                }}
        }
    });
