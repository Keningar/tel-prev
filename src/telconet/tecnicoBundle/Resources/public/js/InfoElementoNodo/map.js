...
function validacionesForm(){
    ...
    if(!validarCoordenadasPorPaisForm(document.forms[0], "telconet_schemabundle_infoelementonodotype"))
        return false;
    
    $("#latitudUbicacion").val(valor_latitud);
    $("#longitudUbicacion").val(valor_longitud);
    return true;
}
...
function validarCoordenadasEcuador(formulario)
  {
    ...
    $("#telconet_schemabundle_infoelementonodotype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementonodotype_longitudUbicacion").val(valor_longitud);
...
function muestraMapaEdit(lat, long) {
