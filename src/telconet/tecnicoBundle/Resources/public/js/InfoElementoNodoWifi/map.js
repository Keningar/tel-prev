...
{
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_nombreElemento").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    
       if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_cantonId").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_parroquiaId").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_descripcionElemento").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    ...
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_modeloElementoId").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
...
function validacionesForm(){
    ...
    if(   document.getElementById("telconet_schemabundle_infoelementonodowifitype_parroquiaId").value== "" 
       || document.getElementById("telconet_schemabundle_infoelementonodowifitype_parroquiaId").value== 0 ){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    ...
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_direccionUbicacion").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    ...
    if(document.getElementById("telconet_schemabundle_infoelementonodowifitype_alturaSnm").value==""){
        alert("Favor ingresar los campos obligatorios *");
        return false;
    }
    ...
    if(!validarCoordenadasPorPaisForm(document.forms[0], "telconet_schemabundle_infoelementonodowifitype"))
        return false;
...
function validarCoordenadasEcuador(formulario)
  {
    ...
    $("#telconet_schemabundle_infoelementonodowifitype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementonodowifitype_longitudUbicacion").val(valor_longitud);
