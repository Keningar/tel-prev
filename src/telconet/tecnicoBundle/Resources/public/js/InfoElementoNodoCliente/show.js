...
Ext.onReady(function(){
    ...
    var storeElementosPorCaja = new Ext.data.Store({ 
        total: 'total',
        autoLoad:true,
        proxy: {
            type: 'ajax',
            url : 'getElementosPorNodoCliente',
            reader: {
                type: 'json',
                totalProperty: 'total',
                root: 'encontrados'
    ...
    gridElementosPorCaja = Ext.create('Ext.grid.Panel', {
        id:'gridElementosPorCaja',
        store: storeElementosPorCaja,
        columnLines: true,
