Ext.onReady(function(){ 
    ...
    var accion="cargarDatosNodoCliente";
          ...
          success: function(response)
                   {
                     ...
                     if(json.total>0){
                         ...
                         agregarValue("telconet_schemabundle_infoelementonodoclientetype_jurisdiccionId", json.encontrados[0]['idJurisdiccion']);
                         presentarCantonesEdit(Ext.get('telconet_schemabundle_infoelementonodoclientetype_jurisdiccionId'), "telconet_schemabundle_infoelementonodoclientetype_cantonId",  "encontrados", "",json.encontrados[0]['idCanton'], json.encontrados[0]['idParroquia']);
                     }
                     else{
                         alert("sin datos");
                     }
          ...
          success: function(response)
                   {
                     ...
                     if(root == 'encontrados')
                     {
                       llenarCombo(objeto_2, json.encontrados, 'encontrados', seleccion, 'nombre_canton', 'id_canton', 'telconet_schemabundle_infoelementonodoclientetype_cantonId', valor_campo);
                       
                       presentarParroquiasEdit(Ext.get('telconet_schemabundle_infoelementonodoclientetype_cantonId'), "telconet_schemabundle_infoelementonodoclientetype_parroquiaId", "encontrados", "",valor_campo1);
                     }
                   },
          failure: function(result)
                   {
          ...
          success: function(response)
                   {
                     ...
                     if(root == 'encontrados')
                     {
                       llenarCombo(objeto_2, json.encontrados, 'encontrados', seleccion, 'nombre_parroquia', 'id_parroquia', 'telconet_schemabundle_infoelementonodoclientetype_parroquiaId', valor_campo);
