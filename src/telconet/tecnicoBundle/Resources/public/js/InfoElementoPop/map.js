...
function validacionesForm(){
    //validar nombre 
    if(document.getElementById("telconet_schemabundle_infoelementopoptype_nombreElemento").value==""){
    ...
    if(!validarCoordenadasPorPaisForm(document.forms[0], "telconet_schemabundle_infoelementopoptype"))
        return false;
...
//    Ext.getCmp('telconet_schemabundle_infoelementodslamtype_longitudUbicacion').value = valor_longitud;
    ...
    $("#telconet_schemabundle_infoelementopoptype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementopoptype_longitudUbicacion").val(valor_longitud);
