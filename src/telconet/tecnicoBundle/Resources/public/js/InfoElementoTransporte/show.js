...
Ext.onReady(function() { 
    var store = new Ext.data.Store({ 
           ...
           proxy: {
               type: 'ajax',                
               url: url_showDocumentosCaducadosTransporte,               
               reader: {
                   type: 'json', 
                   totalProperty: 'total', 
                   root: 'docs'
        ...
        //console.log(count);
            ...
            {
                var gridDocumentosDigitalesCaducadosTransporte = Ext.create('Ext.grid.Panel', {
                              id: 'gridDocumentosDigitalesCaducadosTransporte',
                              store: store,
                              timeout: 60000,
                              dockedItems: [ {
                                      xtype: 'toolbar',
                        ...
                        var pop = Ext.create('Ext.window.Window', {
                            ...
                            shadow: true,
                            shadowOffset:20,
                            items: [gridDocumentosDigitalesCaducadosTransporte] 
                        });
                    pop.show();
            }
    });
