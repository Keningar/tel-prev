...
Ext.onReady(function(){                         
    ...
    var listView = Ext.create('Ext.grid.Panel', {
        ...
        dockedItems: [ {
                        ...
                        items: [
                                ...
                                itemId: 'delete',
                                scope: this,
                                handler: function(){eliminarDocumentosTransporte(2,'');}
                        }]}],                    
    ...
    function renderAcciones(value, p, record) {
        ...
        iconos      =iconos+'<b><a href="#" onClick="eliminarDocumentosTransporte(1,\''+record.data.id+'\')" '
...
function eliminarDocumentosTransporte(tipo,idDocumento)
{
    var param = '';
    var idDocumentoTransporte='';
    var estado = 0;
    var strAlerta='';
    var boolError=false;
    ...
    if(tipo==1)
    {
        idDocumentoTransporte=idDocumento;
        ...
        Ext.Msg.confirm('Alerta',strAlerta, function(btn){
            if(btn=='yes'){
                  ...
                  Ext.Ajax.request({
                      url: url_eliminar,
                      method: 'post',
                      params: { id:idDocumentoTransporte, param : param, tipo:tipo},
