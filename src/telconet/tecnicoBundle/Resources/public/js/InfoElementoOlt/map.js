...
//    Ext.getCmp('telconet_schemabundle_infoelementodslamtype_longitudUbicacion').value = valor_longitud;
    ...
    $("#telconet_schemabundle_infoelementodslamtype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementodslamtype_longitudUbicacion").val(valor_longitud);
