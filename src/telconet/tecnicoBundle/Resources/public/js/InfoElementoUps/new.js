...
Ext.onReady(function()
{
        ...
        listeners: 
        {
            select: 
            {
                fn: function(combo, value) 
                {
                    ...
                    if( combo.getValue() != '' && combo.getValue() != null)
                    {
                        getModelos(storeModelos, combo.getValue());
                    }
                }
            }
        },
    ...
    function getModelos(store, marcaId)
    {
        store.proxy.extraParams = {idMarca: marcaId, tipoElemento: 'UPS'};
        store.load();
    }
