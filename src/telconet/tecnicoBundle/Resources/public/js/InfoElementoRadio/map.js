...
//    Ext.getCmp('telconet_schemabundle_infoelementoradiotype_latitudUbicacion').value = valor_latitud;
//    Ext.getCmp('telconet_schemabundle_infoelementoradiotype_longitudUbicacion').value = valor_longitud;
    
    $("#telconet_schemabundle_infoelementoradiotype_latitudUbicacion").val(valor_latitud);
    $("#telconet_schemabundle_infoelementoradiotype_longitudUbicacion").val(valor_longitud);
