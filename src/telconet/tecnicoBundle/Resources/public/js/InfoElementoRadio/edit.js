...
Ext.onReady(function(){ 
    ...
    $('#telconet_schemabundle_infoelementoradiotype_modeloElementoId').attr('disabled',true);
    
    var intRadioInicio = null;
    ...
    combo_radioInicioId = new Ext.form.ComboBox({
        ...
        listeners: {
            ...
            change: function(object, newValue, odlValue, eOpts)
                    {
                        if (intRadioInicio != null)
                        {
                            $('#telconet_schemabundle_infoelementoradiotype_radioInicioId').val(intRadioInicio);
                            intRadioInicio = null; 
                        }
                        else
                        {
    ...
    if (nombreNodo != null && nombreNodo.trim() != "")
    {
        storeNodo.proxy.extraParams = { nombreElemento: nombreNodo,
                                        modeloElemento: '',
                                        marcaElemento: '',
                                        canton: '',
                                        jurisdiccion: '',
    ...
    combo_switch = new Ext.form.ComboBox({
        ...
        listeners: {
            select: {fn: function(combo, value) {
                    ...
                    Ext.getCmp('combo_intSwitch').setVisible(true);
                    var element = document.getElementById("idIntSw");
                    if (element != null)
                    {
    ...
    if (nombreNodo != null && nombreNodo.trim() != "")
    {
        combo_nodos.setValue(parseInt($('#telconet_schemabundle_infoelementoradiotype_nodoElementoId').val()));
    }
    
    if (nombreSwitch != null && nombreSwitch.trim() != "" && $('#telconet_schemabundle_infoelementoradiotype_tipoElementoRed').val() == 'BACKBONE')
    {
        storeSwitch.proxy.extraParams = { nombreElemento: nombreSwitch,
                                          marcaElemento:  '',
                                          modeloElemento: '',
                                          canton:         '',
                                          jurisdiccion:   '',
    ...
    if (nombreSwitch != null && nombreSwitch.trim() != "" && $('#telconet_schemabundle_infoelementoradiotype_tipoElementoRed').val() == 'BACKBONE')
    {
        combo_switch.setValue(parseInt($('#telconet_schemabundle_infoelementoradiotype_switchElementoId').val()));
    }
    
    if ($('#telconet_schemabundle_infoelementoradiotype_tipoElementoRed').val() != "")
    {
        var valorTipoElementoRed= $('#telconet_schemabundle_infoelementoradiotype_tipoElementoRed').val();
        Ext.getCmp('combo_tipoElementoRed').setValue(valorTipoElementoRed);
        if (valorTipoElementoRed != 'BACKBONE')
        {
            Ext.getCmp('combo_intSwitch').reset();
            Ext.getCmp('combo_intSwitch').setDisabled(false);
            Ext.getCmp('combo_intSwitch').setVisible(true);
            ...
            Ext.getCmp('combo_radioInicioId').reset();
            Ext.getCmp('combo_radioInicioId').setDisabled(false);
            Ext.getCmp('combo_radioInicioId').setVisible(true);
            if (valorTipoElementoRed == 'REPETIDORA IN')
            {
                valorTipoElementoRed = 'BACKBONE';
            }
            else
            {
                valorTipoElementoRed = 'REPETIDORA IN';
            }
            storeElementosRadio.proxy.extraParams = {tipoElementoRed: valorTipoElementoRed,elemento: 'RADIO'};
            storeElementosRadio.load({
                callback: function() 
                {
                    intRadioInicio = $('#telconet_schemabundle_infoelementoradiotype_radioInicioId').val();
                    Ext.getCmp('combo_radioInicioId').setValue(parseInt($('#telconet_schemabundle_infoelementoradiotype_radioInicioId').val()));
                }
            });
...
function validacionesForm() {
    ...
    {
        alert("Falta llenar algunos campos (nombre elemento)");
        return false;
    }
    ...
    {
        alert("Falta llenar algunos campos (ip)");
        return false;
    }
    ...
    {
        alert("Falta llenar algunos campos (modelo)");
        return false;
    }
    ...
    {
        alert("Falta llenar algunos campos (sid)");
        return false;
    }
    ...
    {
        alert("Falta llenar algunos campos (mac)");
        return false;
    }
    else
    {
    ...
    {
        alert("Falta llenar algunos campos (nodo)");
        return false;
    }
    ...
    {
        alert("Falta llenar algunos campos (tipo elemento red)");
        return false;
    }
    else
    {
        if (combo_tipoElementoRed.value != "BACKBONE")
        {
            ...
            {
                alert("Falta llenar algunos campos (radio inicio)");
                return false;
            }
        }
        else
        {
            ...
            {
                alert("Falta llenar algunos campos (switch)");
                return false;
            }
            
            var elementoIntSw = document.getElementById("idIntSw");
            
            //validar interface switch
            if ((document.getElementById("telconet_schemabundle_infoelementoradiotype_interfaceSwitchId").value == "" || 
                combo_intSwitch.value == "" || combo_intSwitch.value == null) && (elementoIntSw == null)) 
            {
                alert("Falta llenar algunos campos (interface switch)");
                return false;
            }
        }
    }
    $('#telconet_schemabundle_infoelementoradiotype_modeloElementoId').attr('disabled',false);
    return true;
}
