...
/**
  * Clase ConvertirJsonEnImagenService
  *
  * Clase que se encarga de generar la firma digital en imagen
  *
  * @author Francisco Adum <fadum@telconet.ec>
  * @version 1.0 28-07-2014
  */
class ConvertirJsonEnImagenService {
    ...
    function sigJsonToImage ($json, $options = array()) 
    {
        ...
        imagecopyresampled($imgDest, $img, 0, 0, 0, 0, $options['imageSize'][0], 
                           $options['imageSize'][0], 
