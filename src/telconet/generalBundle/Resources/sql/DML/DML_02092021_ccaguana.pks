        ...
        <div id="contenedor" class="col-width-100" style="font-size:14px;">
         ...
         <div>
             <span style="font-size:11px">
                 ...
                 Quito, Parroquia Iñaquito, Tel&eacute;fonos: 39-20-000, RUC: 1791287541001, mail: info@netlife.net.ec, web:www.netlife.ec/puntos-de-atencion/ 2) por otra
...
INSERT INTO DB_GENERAL.ADMI_PARAMETRO_CAB
  ...
  (
    ...
    'VALORES QUE SE PRESENTARAN EN LAS OBSERVACIONES DE LOS DOCUMENTOS DIGITALES',
    'COMERCIAL',
    'Activo',
    'ccaguana',
     SYSDATE,
...
INSERT INTO DB_GENERAL.ADMI_PARAMETRO_DET
  ...
  (
     ...
     NOMBRE_PARAMETRO= 'VALORES_OBSERVACIONES_CONTRATO_DIGITAL' AND ESTADO= 'Activo'),
    'APLICA_PROMO_MENSUAL',
     'Si Aplica Promoción',
    'Activo',
    'ccaguana',
     SYSDATE,
