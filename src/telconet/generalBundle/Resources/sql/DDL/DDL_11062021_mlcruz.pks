CREATE OR REPLACE AND RESOLVE JAVA SOURCE NAMED DB_GENERAL."HttpPostMultipart" AS 
import java.io.*;
...
public class HttpPostMultipart { 
    ...
    public static synchronized String guardarArchivoNfs(String urlMicroService, String pathArchivo, String nombreArchivo,
                                                        String pathAdicional, String codigoApp, String codigoPath)
    {
    String respuesta="";
        try{
            ...
            multipart.addFilePart("file", new File(pathArchivo));

            if(pathAdicional == null || pathAdicional.equals("") || pathAdicional.trim().equals(""))
            {
                request =   "{\n" +
                            "  \"data\": [\n" +
                            "    {\n" +
    ...
    public static synchronized  String contieneTexto(String texto, String textoABuscar){
