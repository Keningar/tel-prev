...
class DefaultCsrfProvider implements CsrfProviderInterface
{
    ...
    public function generateCsrfToken2($intention)
    {
        return sha1($this->secret.$intention);
    }

    public function isCsrfTokenValid2($intention, $token)
    {
        return $token === $this->generateCsrfToken2($intention);
    }
